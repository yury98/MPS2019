...
void ARINC429R_BRG_Init(uint32_t ARINC429R_BRG)
{
	...
	ARINC429Rx->CONTROL1 |= ((ARINC429R_BRG & 0x0F )<< ARINC429R_CONTROL1_DIV_Pos);
	ARINC429Rx->CONTROL2 |= (((ARINC429R_BRG & 0x70)>>4) << ARINC429R_CONTROL2_DIV_6_4_Pos);
}
...
/**
  ...
  *         	@note Available only for MK MDR1986BE3
...
/**
  ...
  * @warning May be ususe only for MK MDR1986BE3.
  * @param	ARINC429R_CHANNELx: Slect the ARINC429R channel.
  *         This parameter can be one of the following values:
  *         	@arg ARINC429R_CHANNEL1
  *         	@arg ARINC429R_CHANNEL2
...
/**
  ...
  * @note	May be ususe only for MK MDR1986BE3.
  * @param	ARINC429R_CHANNELx: Slect the ARINC429R channel.
  *         This parameter can be one of the following values:
  *         	@arg ARINC429R_CHANNEL1
  *         	@arg ARINC429R_CHANNEL2
