...
#line 25 "..\\..\\src_fatfs\\ff.h"
#line 1 "..\\..\\src_fatfs\\ffconf.h"
...
#line 262 "..\\..\\src_fatfs\\ff.h"

 
#line 270 "..\\..\\src_fatfs\\ff.h"
...
#line 332 "..\\..\\src_fatfs\\ff.h"





#line 96 "..\\..\\src_fatfs\\ff.c"
...
#line 119 "..\\..\\src_fatfs\\ff.c"


 
#line 132 "..\\..\\src_fatfs\\ff.c"




 
#line 148 "..\\..\\src_fatfs\\ff.c"
...
#line 166 "..\\..\\src_fatfs\\ff.c"

#line 350 "..\\..\\src_fatfs\\ff.c"
...
#line 377 "..\\..\\src_fatfs\\ff.c"


 
#line 387 "..\\..\\src_fatfs\\ff.c"
...
#line 436 "..\\..\\src_fatfs\\ff.c"

#line 456 "..\\..\\src_fatfs\\ff.c"
...
#line 2653 "..\\..\\src_fatfs\\ff.c"
  res = f_sync(fp);    
#line 2667 "..\\..\\src_fatfs\\ff.c"
...
)
{
  ...
  for (cc = res = 0; cc != (-1); res += cc) {
    ...
    case 'S' :           
      ...
      continue;
    case 'C' :           
      cc = f_putc((TCHAR)__va_arg(arp, int), fil); continue;
    case 'B' :           
      r = 2; break;
    case 'O' :           
      r = 8; break;
    ...
    v = (f & 4) ? (ULONG)__va_arg(arp, long) : ((d == 'D') ? (ULONG)(long)__va_arg(arp, int) : (ULONG)__va_arg(arp, unsigned int));
    if (d == 'D' && (v & 0x80000000)) {
      v = 0 - v;
      f |= 8;
    }
