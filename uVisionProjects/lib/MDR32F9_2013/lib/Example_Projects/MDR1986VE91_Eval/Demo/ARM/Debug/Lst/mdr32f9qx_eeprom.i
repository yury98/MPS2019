...
#line 25 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_eeprom.c"
#line 1 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_eeprom.h"
...
#line 30 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_eeprom.h"
...
#line 61 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_eeprom.h"
...
#line 113 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_eeprom.h"

void EEPROM_SetLatency ( uint32_t EEPROM_Latency );

 uint8_t EEPROM_ReadByte (uint32_t Address, uint32_t BankSelector) __attribute__((section("EXECUTABLE_MEMORY_SECTION")));
 uint16_t EEPROM_ReadHalfWord(uint32_t Address, uint32_t BankSelector) __attribute__((section("EXECUTABLE_MEMORY_SECTION")));
 uint32_t EEPROM_ReadWord(uint32_t Address, uint32_t BankSelector) __attribute__((section("EXECUTABLE_MEMORY_SECTION")));
 void EEPROM_ErasePage(uint32_t Address, uint32_t BankSelector) __attribute__((section("EXECUTABLE_MEMORY_SECTION")));
 void EEPROM_EraseAllPages(uint32_t BankSelector) __attribute__((section("EXECUTABLE_MEMORY_SECTION")));
 void EEPROM_ProgramByte(uint32_t Address, uint32_t BankSelector, uint32_t Data) __attribute__((section("EXECUTABLE_MEMORY_SECTION")));
 void EEPROM_ProgramHalfWord(uint32_t Address, uint32_t BankSelector, uint32_t Data) __attribute__((section("EXECUTABLE_MEMORY_SECTION")));
 void EEPROM_ProgramWord(uint32_t Address, uint32_t BankSelector, uint32_t Data) __attribute__((section("EXECUTABLE_MEMORY_SECTION")));
...
#line 26 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_eeprom.c"
 ...
 static void ProgramDelay(uint32_t Loops) __attribute__((section("EXECUTABLE_MEMORY_SECTION")));
 ...
 static void ProgramDelay(uint32_t Loops)
{
...
void EEPROM_SetLatency ( uint32_t EEPROM_Latency )
{
  ...
  ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = EEPROM_Latency;
}
  ...
  uint8_t EEPROM_ReadByte(uint32_t Address, uint32_t BankSelector)
{
  ...
  ((MDR_EEPROM_TypeDef *) (0x40018000))->KEY = ((uint32_t)0x8AAA5551);
  Command = (((MDR_EEPROM_TypeDef *) (0x40018000))->CMD & ((uint32_t)0x00000038)) | ((uint32_t)0x00000001);
  Command |= (BankSelector == ((uint32_t)0x00000001)) ? ((uint32_t)0x00000200) : 0;
  ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
  ((MDR_EEPROM_TypeDef *) (0x40018000))->ADR = Address;
  ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command | ((uint32_t)0x00000040) | ((uint32_t)0x00000080) | ((uint32_t)0x00000100);
  ((MDR_EEPROM_TypeDef *) (0x40018000))->DO;    
  ((MDR_EEPROM_TypeDef *) (0x40018000))->DO;    
  ((MDR_EEPROM_TypeDef *) (0x40018000))->DO;    
  Data = ((MDR_EEPROM_TypeDef *) (0x40018000))->DO;
  Command &= ((uint32_t)0x00000038);
  ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
  ((MDR_EEPROM_TypeDef *) (0x40018000))->KEY = 0;
 ...
 uint32_t EEPROM_ReadWord(uint32_t Address, uint32_t BankSelector)
{
 ...
 void EEPROM_ErasePage(uint32_t Address, uint32_t BankSelector)
{
  uint32_t Command;
  uint32_t Offset;
  ...
  {
    ((MDR_EEPROM_TypeDef *) (0x40018000))->ADR = Address + Offset;              
    ((MDR_EEPROM_TypeDef *) (0x40018000))->DI = 0;
    Command |= ((uint32_t)0x00000040) | ((uint32_t)0x00000400);
    ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
    ProgramDelay(((uint32_t)((float)(5) * (8.0) / (8UL))));               
    Command |= ((uint32_t)0x00002000);
    ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
    ProgramDelay(((uint32_t)((float)(40000) * (8.0) / (8UL))));           
    Command &= ~((uint32_t)0x00000400);
    ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
    ProgramDelay(((uint32_t)((float)(5) * (8.0) / (8UL))));               
    Command &= ~(((uint32_t)0x00000040) | ((uint32_t)0x00002000));
    ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
    ProgramDelay(((uint32_t)((float)(1) * (8.0) / (8UL))));               
  }
  Command &= ((uint32_t)0x00000038);
  ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
  ((MDR_EEPROM_TypeDef *) (0x40018000))->KEY = 0;
 ...
 void EEPROM_EraseAllPages(uint32_t BankSelector)
{
  uint32_t Command;
  uint32_t Offset;
  ...
  ((MDR_EEPROM_TypeDef *) (0x40018000))->KEY = ((uint32_t)0x8AAA5551);
  Command = (((MDR_EEPROM_TypeDef *) (0x40018000))->CMD & ((uint32_t)0x00000038)) | ((uint32_t)0x00000001);
  Command |= (BankSelector == ((uint32_t)0x00000002)) ? ((uint32_t)0x00000200) : 0;

  ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;

  for (Offset = 0; Offset < (4 << 2); Offset += 4)
  {
    ((MDR_EEPROM_TypeDef *) (0x40018000))->ADR = Offset;
    ((MDR_EEPROM_TypeDef *) (0x40018000))->DI = 0;
    Command |= ((uint32_t)0x00000040) | ((uint32_t)0x00000800) | ((uint32_t)0x00000400);
    ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
    ProgramDelay(((uint32_t)((float)(5) * (8.0) / (8UL))));                 
    Command |= ((uint32_t)0x00002000);
    ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
    ...
    Command &= ~((uint32_t)0x00000400);
    ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
    ProgramDelay(((uint32_t)((float)(100) * (8.0) / (8UL))));               
    Command &= ~(((uint32_t)0x00000040) | ((uint32_t)0x00000800) | ((uint32_t)0x00002000));
    ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
    ProgramDelay(((uint32_t)((float)(1) * (8.0) / (8UL))));                 
  }
  Command &= ((uint32_t)0x00000038);
 ...
 void EEPROM_ProgramByte(uint32_t Address, uint32_t BankSelector, uint32_t Data)
{
  uint32_t Mask;
  uint32_t Tmp;
  uint32_t Shift;
 ...
 void EEPROM_ProgramHalfWord(uint32_t Address, uint32_t BankSelector, uint32_t Data)
{
  uint32_t Mask;
  uint32_t Tmp;
  uint32_t Shift;
 ...
 void EEPROM_ProgramWord(uint32_t Address, uint32_t BankSelector, uint32_t Data)
{
  uint32_t Command;
  ...
  ((MDR_EEPROM_TypeDef *) (0x40018000))->KEY = ((uint32_t)0x8AAA5551);
  BankSelector = (BankSelector == ((uint32_t)0x00000001)) ? ((uint32_t)0x00000200) : 0;
  Command = ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD & ((uint32_t)0x00000038);
  Command |= ((uint32_t)0x00000001) | BankSelector;
  ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
  ((MDR_EEPROM_TypeDef *) (0x40018000))->ADR = Address;
  ((MDR_EEPROM_TypeDef *) (0x40018000))->DI  = Data;
  Command |= ((uint32_t)0x00000040) | ((uint32_t)0x00001000);
  ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
  ProgramDelay(((uint32_t)((float)(5) * (8.0) / (8UL))));                 
  Command |= ((uint32_t)0x00002000);
  ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
  ProgramDelay(((uint32_t)((float)(10) * (8.0) / (8UL))));                
  Command |= ((uint32_t)0x00000080);
  ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
  ProgramDelay(((uint32_t)((float)(40) * (8.0) / (8UL))));                
  Command &= ~((uint32_t)0x00000080);
  ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
  Command &= ~((uint32_t)0x00001000);
  ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
  ProgramDelay(((uint32_t)((float)(5) * (8.0) / (8UL))));                 
  Command &= ~(((uint32_t)0x00000040) | ((uint32_t)0x00002000));
  ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
  ...
  ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command & ((uint32_t)0x00000038);
  ((MDR_EEPROM_TypeDef *) (0x40018000))->KEY = 0;
}
