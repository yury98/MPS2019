...
void PORT_Init(MDR_PORT_TypeDef* PORTx, const PORT_InitTypeDef* PORT_InitStruct)
{
  ...
  PORTx->OE     = tmpreg_OE & (~(((PORTx) == ((MDR_PORT_TypeDef *) (0x400C0000))) ? 0x001FU : 0));
  PORTx->FUNC   = tmpreg_FUNC & (~(((PORTx) == ((MDR_PORT_TypeDef *) (0x400C0000))) ? 0x001FU : 0));
  PORTx->ANALOG = tmpreg_ANALOG & (~(((PORTx) == ((MDR_PORT_TypeDef *) (0x400C0000))) ? 0x001FU : 0));
  PORTx->PULL   = tmpreg_PULL & (~(((PORTx) == ((MDR_PORT_TypeDef *) (0x400C0000))) ? 0x001FU : 0));
  PORTx->PD     = tmpreg_PD & (~(((PORTx) == ((MDR_PORT_TypeDef *) (0x400C0000))) ? 0x001FU : 0));
  PORTx->PWR    = tmpreg_PWR & (~(((PORTx) == ((MDR_PORT_TypeDef *) (0x400C0000))) ? 0x001FU : 0));
  PORTx->GFEN   = tmpreg_GFEN & (~(((PORTx) == ((MDR_PORT_TypeDef *) (0x400C0000))) ? 0x001FU : 0));
...
void PORT_SetBits ( MDR_PORT_TypeDef* PORTx, uint32_t PORT_Pin )
{
	...
	PORTx->RXTX = PORT_Pin | (PORTx->RXTX & (~(((PORTx) == ((MDR_PORT_TypeDef *) (0x400C0000))) ? 0x001FU : 0)));
...
void PORT_ResetBits(MDR_PORT_TypeDef* PORTx, uint32_t PORT_Pin)
{
  ...
  PORTx->RXTX &= ~(PORT_Pin | (((PORTx) == ((MDR_PORT_TypeDef *) (0x400C0000))) ? 0x001FU : 0));
...
void PORT_WriteBit(MDR_PORT_TypeDef* PORTx, uint32_t PORT_Pin, BitAction BitVal)
{
  ...
  portdata = PORTx->RXTX & (~(((PORTx) == ((MDR_PORT_TypeDef *) (0x400C0000))) ? 0x001FU : 0));
  if (BitVal != Bit_RESET)
  {
...
void PORT_Write(MDR_PORT_TypeDef* PORTx, uint32_t PortVal)
{
  ...
  PORTx->RXTX = PortVal & (~(((PORTx) == ((MDR_PORT_TypeDef *) (0x400C0000))) ? 0x001FU : 0));
}
