...
#line 25 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_uart.c"
...
#line 26 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_uart.c"
...
#line 27 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_uart.c"
...
#line 70 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_uart.c"
...
void UART_DeInit(MDR_UART_TypeDef* UARTx)
{
  ...
  UARTx->LCR_H = 0;
  UARTx->RSR_ECR = 0;
  UARTx->FR = ((uint32_t)0x00000080) | ((uint32_t)0x00000010);
  UARTx->ILPR = 0;
  UARTx->IBRD = 0;
  UARTx->FBRD = 0;
  UARTx->IFLS = ((uint32_t)0x00000002);
  UARTx->IMSC = 0;
  UARTx->DMACR = 0;
   
  UARTx->CR = ((uint16_t)0x0200) | ((uint16_t)0x0100);
}
...
#line 141 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_uart.c"
			tmpreg = ((MDR_RST_CLK_TypeDef *) (0x40020000))->UART_CLOCK;

	if (UARTx == ((MDR_UART_TypeDef *) (0x40030000))) {
		cpuclock /= (1 << (tmpreg & ((uint32_t)0x0007)));
	}
	else
		if (UARTx == ((MDR_UART_TypeDef *) (0x40038000))) {
			cpuclock /= (1 << ((tmpreg & ((uint32_t)0x0700)) >> ((uint32_t)0x0008)));
		}
#line 160 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_uart.c"

	 
	divider = cpuclock / (UART_InitStruct->UART_BaudRate >> 2);
	integerdivider = divider >> 6;
	 
	fractionaldivider = (divider & ((uint16_t)0x003F));
...
void UART_StructInit(UART_InitTypeDef* UART_InitStruct)
{
  ...
  UART_InitStruct->UART_WordLength = ((uint16_t)0x0000);
  UART_InitStruct->UART_StopBits = ((uint16_t)0x0000);
  UART_InitStruct->UART_Parity = ((uint16_t)0x0000);
  UART_InitStruct->UART_FIFOMode = ((uint16_t)0x0000);
  UART_InitStruct->UART_HardwareFlowControl = ((uint16_t)0x0200) | ((uint16_t)0x0100);
}
...
void UART_Cmd(MDR_UART_TypeDef* UARTx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    UARTx->CR |= ((uint16_t)0x0001);
  }
  else
  {
     
    UARTx->CR &= ((uint16_t)0xFFFE);
  }
}
...
void UART_BreakLine(MDR_UART_TypeDef* UARTx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    UARTx->LCR_H |= ((uint16_t)0x0001);
  }
  else
  {
     
    UARTx->LCR_H |= ((uint16_t)0xFFFE);
  }
}
...
void UART_IrDAConfig(MDR_UART_TypeDef* UARTx, uint32_t UART_IrDAMode)
{
  ...
  if (UART_IrDAMode == ((uint32_t)0x00000004))
  {
     
    RST_CLK_GetClocksFreq(&RST_CLK_Clocks);
    cpuclock = RST_CLK_Clocks.CPU_CLK_Frequency;
    UARTx->ILPR = cpuclock / ((uint32_t)1843200);
  }
...
void UART_IrDACmd(MDR_UART_TypeDef* UARTx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    UARTx->CR |= ((uint16_t)0x0002);
  }
  else
  {
     
    UARTx->CR |= ((uint16_t)0xFFFD);
  }
}
...
void UART_BRGInit(MDR_UART_TypeDef* UARTx, uint32_t UART_BRG)
{
  ...
  else if (UARTx == ((MDR_UART_TypeDef *) (0x40038000)))
  {
