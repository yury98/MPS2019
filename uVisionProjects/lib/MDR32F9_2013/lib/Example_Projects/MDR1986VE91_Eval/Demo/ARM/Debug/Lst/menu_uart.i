...
void SenderFuncFIFODemo(void)
{
  if (error_flag == 0)
  {
    for (; ((UART_GetFlagStatus (((MDR_UART_TypeDef *) (0x40030000)), ((uint32_t)0x00000020)) == RESET) && (send_buffer_pos < (14 * 14))); send_buffer_pos++)
    {
      UART_SendData(((MDR_UART_TypeDef *) (0x40030000)), SendBuffer[send_buffer_pos]);
    }
  }
}
...
void ReceiverFuncFIFODemo(void)
{
  ...
  if (error_flag == 0)
  {
    for (; ((UART_GetFlagStatus(((MDR_UART_TypeDef *) (0x40030000)), ((uint32_t)0x00000010)) == RESET) && (receive_buffer_pos < (14 * 14)) && (error_flag == 0));
             receive_buffer_pos++)
    {
...
void UARTwFIFOFunc(void) {
  ...
  UART_ITConfig (((MDR_UART_TypeDef *) (0x40030000)), ((uint32_t)0x00000020) | ((uint32_t)0x00000010), ENABLE);

   
  UART_DMAConfig (((MDR_UART_TypeDef *) (0x40030000)), ((12) == 2 ? ((uint32_t)0x00000000) : (12) == 4 ? ((uint32_t)0x00000001) : (12) == 8 ? ((uint32_t)0x00000002) : (12) == 12 ? ((uint32_t)0x00000003) : (12) == 14 ? ((uint32_t)0x00000004) : 0xFFFF),
  ...
  UART_DMACmd(((MDR_UART_TypeDef *) (0x40030000)), ((uint32_t)0x00000002) | ((uint32_t)0x00000001), ENABLE);
...
void UARTFunc(void) {
  ...
  for (; key != SEL; key = GetKey())
  {
    if ((key != NOKEY) && (key != MULTIPLE))
    {
      ...
      while (UART_GetFlagStatus (((MDR_UART_TypeDef *) (0x40030000)), ((uint32_t)0x00000040)) == SET)
      {
        UART_ReceiveData (((MDR_UART_TypeDef *) (0x40030000)));
      }
      ...
      for (pdata = SendData[key - 1], i = 0; ((*pdata != 0) && (error_flag == 0)); pdata++, i++)
      {
        LCD_PUTC(CurrentFont->Width * (6 + i),
                 CurrentFont->Height * 4 + 8,
                 *pdata);
        UART_SendData (((MDR_UART_TypeDef *) (0x40030000)), *pdata);
         
        while (UART_GetFlagStatus (((MDR_UART_TypeDef *) (0x40030000)), ((uint32_t)0x00000020)) == SET);
        while (UART_GetFlagStatus (((MDR_UART_TypeDef *) (0x40030000)), ((uint32_t)0x00000008)) == SET);
         
        while (UART_GetFlagStatus (((MDR_UART_TypeDef *) (0x40030000)), ((uint32_t)0x00000010)) == SET);
        receive_data = UART_ReceiveData (((MDR_UART_TypeDef *) (0x40030000)));
