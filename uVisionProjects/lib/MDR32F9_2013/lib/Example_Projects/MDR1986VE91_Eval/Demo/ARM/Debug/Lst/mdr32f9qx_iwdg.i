...
#line 24 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_iwdg.c"
#line 1 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_iwdg.h"
...
#line 30 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_iwdg.h"
...
#line 67 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_iwdg.h"
...
#line 25 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_iwdg.c"
...
void IWDG_WriteAccessEnable(void)
{
  ((MDR_IWDG_TypeDef *) (0x40068000))->KR = ((uint32_t)0x5555);
}
...
void IWDG_WriteAccessDisable(void)
{
  ((MDR_IWDG_TypeDef *) (0x40068000))->KR = ((uint32_t)0x0000);
}
...
void IWDG_SetPrescaler(uint32_t IWDG_Prescaler)
{
  ...
  ((MDR_IWDG_TypeDef *) (0x40068000))->PR = IWDG_Prescaler;
}
...
void IWDG_SetReload(uint32_t Reload)
{
  ...
  ((MDR_IWDG_TypeDef *) (0x40068000))->RLR = Reload;
}
...
void IWDG_ReloadCounter(void)
{
  ((MDR_IWDG_TypeDef *) (0x40068000))->KR = ((uint32_t)0xAAAA);
}
...
void IWDG_Enable(void)
{
  ((MDR_IWDG_TypeDef *) (0x40068000))->KR = ((uint32_t)0xCCCC);
}
...
FlagStatus IWDG_GetFlagStatus(uint32_t IWDG_FLAG)
{
  ...
  ((void)0);
  if ((((MDR_IWDG_TypeDef *) (0x40068000))->SR & IWDG_FLAG) != (uint32_t)RESET)
  {
    bitstatus = SET;
  }
  else
