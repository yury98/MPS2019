...
#line 24 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_wwdg.c"
#line 1 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_wwdg.h"
...
#line 30 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_wwdg.h"
...
#line 63 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_wwdg.h"
...
#line 25 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_wwdg.c"
...
#line 26 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_wwdg.c"
...
void WWDG_SetPrescaler(uint32_t WWDG_Prescaler)
{
  ...
  tmpreg = ((MDR_WWDG_TypeDef *) (0x40060000))->CFR & ((uint32_t)0xFFFFFE7F);
   
  tmpreg |= WWDG_Prescaler;
   
  ((MDR_WWDG_TypeDef *) (0x40060000))->CFR = tmpreg;
}
...
void WWDG_SetWindowValue(uint32_t WindowValue)
{
  ...
  tmpreg = ((MDR_WWDG_TypeDef *) (0x40060000))->CFR & (uint32_t) (~((uint32_t)0x7F));
...
void WWDG_EnableIT ( void )
{
	...
	*(volatile uint32_t *) (0x42000000 + ((uint32_t)&((MDR_WWDG_TypeDef*)((0x40060000) - 0x40000000))->CFR)*32 + 9*4) = (uint32_t) ENABLE;
...
void WWDG_SetCounter(uint32_t Counter)
{
  ...
  ((MDR_WWDG_TypeDef *) (0x40060000))->CR = Counter & ((uint32_t)0x7F);
}
...
void WWDG_Enable(uint32_t Counter)
{
  ...
  ((void)0);
  ((MDR_WWDG_TypeDef *) (0x40060000))->CR = ((uint32_t)0x00000080) | Counter;
}
...
FlagStatus WWDG_GetFlagStatus(void)
{
  return (FlagStatus)(((MDR_WWDG_TypeDef *) (0x40060000))->SR);
}
...
void WWDG_ClearFlag(void)
{
  ((MDR_WWDG_TypeDef *) (0x40060000))->SR = (uint32_t)RESET;
}
