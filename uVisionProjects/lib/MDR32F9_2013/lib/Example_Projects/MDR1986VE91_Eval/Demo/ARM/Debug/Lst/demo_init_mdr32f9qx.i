#line 1 "..\\..\\src\\Demo_Init_MDR32F9Qx.c"
...
#line 23 "..\\..\\src\\Demo_Init_MDR32F9Qx.c"
#line 24 "..\\..\\src\\Demo_Init_MDR32F9Qx.c"
...
#line 25 "..\\..\\src\\Demo_Init_MDR32F9Qx.c"
...
#line 26 "..\\..\\src\\Demo_Init_MDR32F9Qx.c"
...
#line 27 "..\\..\\src\\Demo_Init_MDR32F9Qx.c"
#line 28 "..\\..\\src\\Demo_Init_MDR32F9Qx.c"
#line 1 "..\\..\\inc\\lcd.h"
...
#line 29 "..\\..\\src\\Demo_Init_MDR32F9Qx.c"
...
#line 30 "..\\..\\src\\Demo_Init_MDR32F9Qx.c"
#line 1 "..\\..\\inc\\leds.h"
...
#line 31 "..\\..\\src\\Demo_Init_MDR32F9Qx.c"
...
#line 32 "..\\..\\src\\Demo_Init_MDR32F9Qx.c"
...
void ClockConfigure(void)
{
  ...
  RST_CLK_CPU_PLLconfig (((uint32_t)0x00000000),0);
...
void Demo_Init(void)
{
  ...
  PORT_Init(((MDR_PORT_TypeDef *) (0x400A8000)), &PortInitStructure);

   
   
  PORT_SetBits(((MDR_PORT_TypeDef *) (0x400B0000)), (0x0400U));

  PortInitStructure.PORT_Pin = (0x0400U);
  ...
  PORT_ResetBits(((MDR_PORT_TypeDef *) (0x400B8000)), (0x0002U));

  PortInitStructure.PORT_Pin = (0x0002U);
  PortInitStructure.PORT_SPEED = PORT_SPEED_FAST;

  PORT_Init(((MDR_PORT_TypeDef *) (0x400B8000)), &PortInitStructure);

   
   
  PORT_ResetBits(((MDR_PORT_TypeDef *) (0x400B0000)), (0x0080U | 0x0100U));

  PortInitStructure.PORT_Pin = (0x0080U | 0x0100U);
  PortInitStructure.PORT_SPEED = PORT_SPEED_SLOW;

  PORT_Init(((MDR_PORT_TypeDef *) (0x400B0000)), &PortInitStructure);

   
  PortInitStructure.PORT_Pin = (0x0001U);

  PORT_Init(((MDR_PORT_TypeDef *) (0x400B8000)), &PortInitStructure);

   
   
  PORT_ResetBits(((MDR_PORT_TypeDef *) (0x400B0000)), (0x0200U));
  ...
  PortInitStructure.PORT_Pin   = 0x0020U;
  ...
  PortInitStructure.PORT_Pin   = 0x0008U;

  PORT_Init(((MDR_PORT_TypeDef *) (0x400C8000)), &PortInitStructure);

   
  PortInitStructure.PORT_Pin   = 0x0040U;
  ...
  PORT_ResetBits(((MDR_PORT_TypeDef *) (0x400B8000)), (0x0001U | 0x0002U));
}
