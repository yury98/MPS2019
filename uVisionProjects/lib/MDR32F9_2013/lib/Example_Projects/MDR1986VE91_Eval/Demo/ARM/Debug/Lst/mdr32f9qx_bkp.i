...
#line 24 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_bkp.c"
...
#line 30 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_bkp.h"
#line 31 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_bkp.h"
...
#line 80 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_bkp.h"

#line 90 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_bkp.h"

#line 99 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_bkp.h"
...
#line 25 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_bkp.c"
...
#line 26 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_bkp.c"
...
#line 66 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_bkp.c"
...
void BKP_DeInit(void)
{
  ...
  uint32_t * _bkp = (uint32_t *) (0x400D8000);
  uint32_t i;

  for ( i = 0; i < ((uint32_t) (((uint32_t)&((MDR_BKP_TypeDef*)((0x400D8000) - 0x40000000))->REG_0E) - ((0x400D8000) - 0x40000000))/4); i++)
  {
    _bkp[i] = 0;
  }

  for ( i = ((uint32_t) (((uint32_t)&((MDR_BKP_TypeDef*)((0x400D8000) - 0x40000000))->RTC_CNT) - ((0x400D8000) - 0x40000000))/4); i <= ((uint32_t) (((uint32_t)&((MDR_BKP_TypeDef*)((0x400D8000) - 0x40000000))->RTC_CS) - ((0x400D8000) - 0x40000000))/4); i++)
  {
    _bkp[i] = 0;
  }

  ((MDR_BKP_TypeDef *) (0x400D8000)) -> REG_0E |= (uint32_t) (((uint32_t)(0x01U<<11)));
  ((MDR_BKP_TypeDef *) (0x400D8000)) -> REG_0E &= (uint32_t) (((uint32_t)(~((0x01U<<31)|(0x07U<<8)|(0x3FU)))));
  ((MDR_BKP_TypeDef *) (0x400D8000)) -> REG_0F = (uint32_t) (((uint32_t)0x00008000));
}
...
void BKP_JTAGA_CMD(FunctionalState NewState)
{
  ...
  *(volatile uint32_t *) (0x42000000 + ((uint32_t)&((MDR_BKP_TypeDef*)((0x400D8000) - 0x40000000))->REG_0E)*32 + 6*4) = (uint32_t)NewState;
}
...
void BKP_JTAGB_CMD(FunctionalState NewState)
{
  ...
  *(volatile uint32_t *) (0x42000000 + ((uint32_t)&((MDR_BKP_TypeDef*)((0x400D8000) - 0x40000000))->REG_0E)*32 + 7*4) = (uint32_t)NewState;
}
...
void BKP_RTCclkSource(uint32_t RTC_CLK)
{
	...
	tmpreg = ((MDR_BKP_TypeDef *) (0x400D8000)) ->REG_0F & (uint32_t) (~((uint32_t)0x0000000C) );
	 
	tmpreg |= ((uint32_t)0x0000000C) & RTC_CLK;
	((MDR_BKP_TypeDef *) (0x400D8000)) ->REG_0F = tmpreg;
...
void BKP_RTC_Enable ( FunctionalState NewState )
{
	...
	*(volatile uint32_t *) (0x42000000 + ((uint32_t)&((MDR_BKP_TypeDef*)((0x400D8000) - 0x40000000))->REG_0F)*32 + 4*4) = (uint32_t) NewState;
#line 205 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_bkp.c"
}
...
void BKP_RTC_Calibration(uint32_t RTC_Calibration)
{
  ...
  tmpreg  = ((MDR_BKP_TypeDef *) (0x400D8000)) -> REG_0F & (uint32_t) (~((uint32_t)0x00001FE0));
   
  tmpreg |= ((uint32_t)0x00001FE0) & (RTC_Calibration << 5);
  ((MDR_BKP_TypeDef *) (0x400D8000)) -> REG_0F = tmpreg;
}
...
void BKP_RTC_Reset ( FunctionalState NewState )
{
	...
	*(volatile uint32_t *) (0x42000000 + ((uint32_t)&((MDR_BKP_TypeDef*)((0x400D8000) - 0x40000000))->REG_0F)*32 + 31*4) = (uint32_t) NewState;
#line 249 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_bkp.c"
}
...
void BKP_RTC_ITConfig(uint32_t BKP_RTC_IT, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ((MDR_BKP_TypeDef *) (0x400D8000))->RTC_CS |= BKP_RTC_IT;
  }
  else
  {
    ((MDR_BKP_TypeDef *) (0x400D8000))->RTC_CS &= (uint32_t)~BKP_RTC_IT;
  }
}
...
uint32_t BKP_RTC_GetCounter(void)
{
  return ((MDR_BKP_TypeDef *) (0x400D8000)) -> RTC_CNT;
}
...
void BKP_RTC_SetCounter(uint32_t CounterValue)
{
  ((MDR_BKP_TypeDef *) (0x400D8000)) -> RTC_CNT = CounterValue;
}
...
void  BKP_RTC_SetAlarm(uint32_t AlarmValue)
{
  ((MDR_BKP_TypeDef *) (0x400D8000)) -> RTC_ALRM = AlarmValue;
}
...
uint32_t BKP_RTC_GetDivider(void)
{
  return ((MDR_BKP_TypeDef *) (0x400D8000)) -> RTC_DIV;
}
...
void BKP_RTC_SetPrescaler(uint32_t PrescalerValue)
{
  ...
  ((MDR_BKP_TypeDef *) (0x400D8000)) -> RTC_PRL = PrescalerValue;
}
...
void BKP_RTC_WaitForUpdate ( void )
{
	...
	while (*(volatile uint32_t *) (0x42000000 + ((uint32_t)&((MDR_BKP_TypeDef*)((0x400D8000) - 0x40000000))->RTC_CS)*32 + 6*4) != 0);
...
FlagStatus BKP_RTC_GetFlagStatus(uint32_t BKP_RTC_FLAG)
{
  ...
  if ((((MDR_BKP_TypeDef *) (0x400D8000)) -> RTC_CS & BKP_RTC_FLAG) != 0)
  {
    status = SET;
  }
  else
