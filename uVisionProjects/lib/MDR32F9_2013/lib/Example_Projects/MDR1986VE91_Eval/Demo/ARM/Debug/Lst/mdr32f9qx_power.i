...
#line 24 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_power.c"
#line 1 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_power.h"
...
#line 30 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_power.h"
...
#line 62 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_power.h"

#line 71 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_power.h"
...
#line 85 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_power.h"

#line 94 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_power.h"
...
#line 111 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_power.h"

#line 120 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_power.h"
...
#line 25 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_power.c"
...
#line 26 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_power.c"
...
void POWER_DeInit(void)
{
  ((MDR_POWER_TypeDef *) (0x40058000)) -> PVDCS = (uint32_t) 0x00000000;
}
...
void POWER_DUccMode(uint32_t DUccMode)
{
  ...
  tmpreg  = ((MDR_BKP_TypeDef *) (0x400D8000)) -> REG_0E & (uint32_t) (~((uint32_t)(((uint32_t)0x00000007) | ((uint32_t)0x00000038))));
   
  tmpreg |= ((uint32_t)(((uint32_t)0x00000007) | ((uint32_t)0x00000038))) & DUccMode;
  ((MDR_BKP_TypeDef *) (0x400D8000)) -> REG_0E = tmpreg;
}
...
void POWER_DUccTrim(uint32_t DUccTrim)
{
  ...
  tmpreg  = ((MDR_BKP_TypeDef *) (0x400D8000)) -> REG_0E & (uint32_t) (~((uint32_t)((uint32_t)0x00000700)));
   
  tmpreg |= ((uint32_t)((uint32_t)0x00000700)) & DUccTrim;
  ((MDR_BKP_TypeDef *) (0x400D8000)) -> REG_0E = tmpreg;
}
...
*(volatile uint32_t *) (0x42000000 + ((uint32_t)&((MDR_BKP_TypeDef*)((0x400D8000) - 0x40000000))->REG_0F)*32 + 30*4) = (uint32_t) 0x01;
...
void POWER_PVDlevelConfig(uint32_t POWER_PVDlevel)
{
  ...
  ((void)0);
  tmpreg = ((MDR_POWER_TypeDef *) (0x40058000))->PVDCS;
   
  tmpreg &= (uint32_t) ~((uint32_t)0x00000038);
   
  tmpreg |= (POWER_PVDlevel & ((uint32_t)0x00000038));
   
  ((MDR_POWER_TypeDef *) (0x40058000))->PVDCS = tmpreg;
}
...
void POWER_PVBDlevelConfig(uint32_t POWER_PVBDlevel)
{
  ...
  tmpreg &= (uint32_t) ~((uint32_t)0x00000006);
   
  tmpreg |= (POWER_PVBDlevel & ((uint32_t)0x00000006));
...
void POWER_SetFlagPOR ( void )
{
	...
	*(volatile uint32_t *) (0x42000000 + ((uint32_t)&((MDR_BKP_TypeDef*)((0x400D8000) - 0x40000000))->REG_0E)*32 + 11*4) = (uint32_t) 0x01;
...
ErrorStatus POWER_FlagPORstatus(void)
{
  ...
  if (*(volatile uint32_t *) (0x42000000 + ((uint32_t)&((MDR_BKP_TypeDef*)((0x400D8000) - 0x40000000))->REG_0E)*32 + 11*4) == 0)
  {
    state = SUCCESS;
  }
...
void POWER_PVDenable ( FunctionalState NewState )
{
	...
	*(volatile uint32_t *) (0x42000000 + ((uint32_t)&((MDR_POWER_TypeDef*)((0x40058000) - 0x40000000))->PVDCS)*32 + 0*4) = (uint32_t) NewState;
#line 285 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_power.c"
}
...
FlagStatus POWER_GetFlagStatus(uint32_t POWER_FLAG)
{
  ...
  if ((((MDR_POWER_TypeDef *) (0x40058000))->PVDCS & POWER_FLAG) != (uint32_t)RESET)
  {
    status = SET;
  }
  else
...
void POWER_ClearFlag(uint32_t POWER_FLAG)
{
  ...
  ((MDR_POWER_TypeDef *) (0x40058000))->PVDCS &= (uint32_t) ~POWER_FLAG;
}
...
void POWER_PVD_ITconfig(uint32_t POWER_IT, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ((MDR_POWER_TypeDef *) (0x40058000))->PVDCS |= POWER_IT;
  }
  else
  {
    ((MDR_POWER_TypeDef *) (0x40058000))->PVDCS &= (uint32_t)~POWER_IT;
  }
}
...
void POWER_PVD_INVconfig(uint32_t POWER_INV, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ((MDR_POWER_TypeDef *) (0x40058000))->PVDCS |= POWER_INV;
  }
  else
  {
    ((MDR_POWER_TypeDef *) (0x40058000))->PVDCS &= (uint32_t)~POWER_INV;
  }
}
...
void POWER_EnterSTOPMode(FunctionalState POWER_Regulator_state, uint8_t POWER_STOPentry)
{
   ...
   *(volatile uint32_t *) (0x42000000 + ((uint32_t)&((MDR_BKP_TypeDef*)((0x400D8000) - 0x40000000))->REG_0F)*32 + 30*4) = (uint32_t) (!POWER_Regulator_state);
    
   *(volatile uint32_t *) ((SCB_Type *) ((0xE000E000) + 0x0D00)) -> SCR |= (1ul << 2);

   if(POWER_Regulator_state == ENABLE){
	   ((MDR_BKP_TypeDef *) (0x400D8000))->REG_0F &= ~((uint32_t)0x40000000);
   }
   else{
	   ((MDR_BKP_TypeDef *) (0x400D8000))->REG_0F |= ((uint32_t)0x40000000);
   }
   
  if(POWER_STOPentry == ((uint32_t)0x01))
  {
...
#line 441 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_power.c"
