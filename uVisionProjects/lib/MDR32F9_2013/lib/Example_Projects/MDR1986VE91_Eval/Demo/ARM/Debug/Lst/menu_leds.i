...
void LightsOnFunc(void)
{
  ...
  saveport = PORT_ReadInputData(((MDR_PORT_TypeDef *) (0x400B8000)));
  ...
  CurrentLights = ((0xAAAAAAAA << (0 & 31)) | (0xAAAAAAAA >> ((32 - 0) & 31)));
  for (tck = 0, tck_led = 0; !(GetKey() == SEL); tck++)
  {
    if (tck == tck_led)
    {
      tck_led += 35000;
  ...
  PORT_Write(((MDR_PORT_TypeDef *) (0x400B8000)), saveport);
