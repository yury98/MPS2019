...
void LCDClock(void)
{
  PORT_SetBits(((MDR_PORT_TypeDef *) (0x400B8000)), (0x0002U));
...
void ResetLCD(void)
{
  PORT_SetBits(((MDR_PORT_TypeDef *) (0x400B0000)), (0x0200U));
...
void SetCrystal(LCD_Crystal num)
{
  ...
  PORT_SetBits(((MDR_PORT_TypeDef *) (0x400B0000)), ((num + 1) << 7));
  LCDClock();
  CurrentCrystal = num;
}
...
void WriteLCD_Cmd(uint32_t val)
{
  ...
  portdata = PORT_ReadInputData(((MDR_PORT_TypeDef *) (0x400A8000))) & (~(0x0001U | 0x0002U | 0x0004U | 0x0008U | 0x0010U | 0x0020U | 0x0040U | 0x0080U));
  portdata |= val;
   
  PORT_ResetBits(((MDR_PORT_TypeDef *) (0x400B8000)), (0x0001U));
   
  PORT_ResetBits(((MDR_PORT_TypeDef *) (0x400B0000)), (0x0400U));

  PORT_Write(((MDR_PORT_TypeDef *) (0x400A8000)), portdata);
   
  ((MDR_PORT_TypeDef *) (0x400A8000))->OE |= (0x0001U | 0x0002U | 0x0004U | 0x0008U | 0x0010U | 0x0020U | 0x0040U | 0x0080U);
...
uint32_t ReadLCD_Cmd(void)
{
  ...
  PORT_SetBits(((MDR_PORT_TypeDef *) (0x400B8000)), (0x0002U));
  ret = PORT_ReadInputData(((MDR_PORT_TypeDef *) (0x400A8000))) & (0x0001U | 0x0002U | 0x0004U | 0x0008U | 0x0010U | 0x0020U | 0x0040U | 0x0080U);
  PORT_ResetBits(((MDR_PORT_TypeDef *) (0x400B8000)), (0x0002U));
...
void LCD_INIT(void)
{
  ...
  for (crystal = LCD_CRYSTAL1; crystal < NUM_LCD_CRYSTALS; crystal++)
  {
    ...
    WhileStatus((uint32_t)(1 << 7));
    WriteLCD_Cmd(0x3F);
    WhileStatus((uint32_t)(1 << 5));
    WriteLCD_Cmd(0xC0 | 0);
  }
}
