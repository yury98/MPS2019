/**
  ******************************************************************************
  * @file    USB_Library\1986BE9x_usb_device.c
...
#define ASSERT_INFO_FILE_ID FILEID__1986BE9X_USB_DEVICE_C
...
/** @defgroup USB_EndPoint_Private USB EndPoint
  * @{
  */
...
static void USB_EP_SetReady(USB_EP_TypeDef EPx, uint32_t val)
{
  ...
  /* Clear pending bits */
  if (val & USB_SEPx_CTRL_EPRDY_Ready)
  {
...
/** @} */ /* End of group USB_EndPoint_Private */

/** @defgroup USB_Device_Private USB Device
  * @{
  */
...
/** @} */ /* End of group USB_Device_Private */
...
*
* END OF FILE 1986BE9x_usb_device.c */
