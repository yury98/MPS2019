...
#ifndef __OPORA_USB_H
#define __OPORA_USB_H
...
typedef struct
{
  uint32_t USB_USBC1_Source;       /*!< Specifies the source for USB_C1, if USB_C2 source is set to USB_C1.
                                        This parameter is one of @ref USB_USBC1_Select_Source values. */
  uint32_t USB_PLLUSBMUL;          /*!< Specifies the source for USB_C1, if USB_C2 source is set to USB_PLL.
                                        This parameter is one of @ref USB_PLLUSB_Select_Source values. */
}USB_Clock_TypeDef;
...
#define USB_HSCR_HOST_MODE_Host              (uint32_t)(1 << USB_HSCR_HOST_MODE_OFFS)
#define USB_HSCR_HOST_MODE_Device            (uint32_t)(1 << (USB_HSCR_HOST_MODE_OFFS + 16))

#define USB_HSCR_RESET_CORE_Reset            (uint32_t)(1 << USB_HSCR_RESET_CORE_OFFS)
#define USB_HSCR_RESET_CORE_Work             (uint32_t)(1 << (USB_HSCR_RESET_CORE_OFFS + 16))

#define USB_HSCR_EN_TX_Set                   (uint32_t)(1 << USB_HSCR_EN_TX_OFFS)
#define USB_HSCR_EN_TX_Reset                 (uint32_t)(1 << (USB_HSCR_EN_TX_OFFS + 16))

#define USB_HSCR_EN_RX_Set                   (uint32_t)(1 << USB_HSCR_EN_RX_OFFS)
#define USB_HSCR_EN_RX_Reset                 (uint32_t)(1 << (USB_HSCR_EN_RX_OFFS + 16))

#define USB_HSCR_DP_PULLUP_Set               (uint32_t)(1 << USB_HSCR_DP_PULLUP_OFFS)
#define USB_HSCR_DP_PULLUP_Reset             (uint32_t)(1 << (USB_HSCR_DP_PULLUP_OFFS + 16))

#define USB_HSCR_DP_PULLDOWN_Set             (uint32_t)(1 << USB_HSCR_DP_PULLDOWN_OFFS)
#define USB_HSCR_DP_PULLDOWN_Reset           (uint32_t)(1 << (USB_HSCR_DP_PULLDOWN_OFFS + 16))

#define USB_HSCR_DM_PULLUP_Set               (uint32_t)(1 << USB_HSCR_DM_PULLUP_OFFS)
#define USB_HSCR_DM_PULLUP_Reset             (uint32_t)(1 << (USB_HSCR_DM_PULLUP_OFFS + 16))

#define USB_HSCR_DM_PULLDOWN_Set             (uint32_t)(1 << USB_HSCR_DM_PULLDOWN_OFFS)
#define USB_HSCR_DM_PULLDOWN_Reset           (uint32_t)(1 << (USB_HSCR_DM_PULLDOWN_OFFS + 16))
...
#define USB_HTXC_TREQ_Set                    (uint32_t)(1 << USB_HTXC_TREQ_OFFS)
#define USB_HTXC_TREQ_Reset                  (uint32_t)(1 << (USB_HTXC_TREQ_OFFS + 16))

#define USB_HTXC_SOFS_Set                    (uint32_t)(1 << USB_HTXC_SOFS_OFFS)
#define USB_HTXC_SOFS_Reset                  (uint32_t)(1 << (USB_HTXC_SOFS_OFFS + 16))

#define USB_HTXC_PREEN_Set                   (uint32_t)(1 << USB_HTXC_PREEN_OFFS)
#define USB_HTXC_PREEN_Reset                 (uint32_t)(1 << (USB_HTXC_PREEN_OFFS + 16))

#define USB_HTXC_ISOEN_Set                   (uint32_t)(1 << USB_HTXC_ISOEN_OFFS)
#define USB_HTXC_ISOEN_Reset                 (uint32_t)(1 << (USB_HTXC_ISOEN_OFFS + 16))
...
#define USB_HTXLC_TXLC_DM_Set                (uint32_t)(1 << USB_HTXLC_OFFS)
#define USB_HTXLC_TXLC_DM_Reset              (uint32_t)(1 << (USB_HTXLC_OFFS + 16))

#define USB_HTXLC_TXLC_DP_Set                (uint32_t)(1 << (USB_HTXLC_OFFS + 1))
#define USB_HTXLC_TXLC_DP_Reset              (uint32_t)(1 << (USB_HTXLC_OFFS + 16 + 1))

#define USB_HTXLC_DC_Direct                  (uint32_t)(1 << USB_HTXLC_DC_OFFS)
#define USB_HTXLC_DC_Normal                  (uint32_t)(1 << (USB_HTXLC_DC_OFFS + 16))

#define USB_HTXLC_FSPL_Full                  (uint32_t)(1 << USB_HTXLC_FSPL_OFFS)
#define USB_HTXLC_FSPL_Low                   (uint32_t)(1 << (USB_HTXLC_FSPL_OFFS + 16))

#define USB_HTXLC_FSLR_12Mb                  (uint32_t)(1 << USB_HTXLC_FSLR_OFFS)
#define USB_HTXLC_FSPL_1_5Mb                 (uint32_t)(1 << (USB_HTXLC_FSLR_OFFS + 16))
...
#define USB_HIM_TDONEIE_Set                  (uint32_t)(1 << USB_HIM_TDONEIE_OFFS)
#define USB_HIM_TDONEIE_Reset                (uint32_t)(1 << (USB_HIM_TDONEIE_OFFS + 16))

#define USB_HIM_RESUMEIE_Set                 (uint32_t)(1 << USB_HIM_RESUMEIE_OFFS)
#define USB_HIM_RESUMEIE_Reset               (uint32_t)(1 << (USB_HIM_RESUMEIE_OFFS + 16))

#define USB_HIM_CONEVIE_Set                  (uint32_t)(1 << USB_HIM_CONEVIE_OFFS)
#define USB_HIM_CONEVIE_Reset                (uint32_t)(1 << (USB_HIM_CONEVIE_OFFS + 16))

#define USB_HIM_SOFIE_Set                    (uint32_t)(1 << USB_HIM_SOFIE_OFFS)
#define USB_HIM_SOFIE_Reset                  (uint32_t)(1 << (USB_HIM_SOFIE_OFFS + 16))
...
#define USB_HRXS_CRCERR_Set                  (uint32_t)(1 << USB_HRXS_CRCERR_OFFS)
#define USB_HRXS_CRCERR_Reset                (uint32_t)(1 << (USB_HRXS_CRCERR_OFFS + 16))

#define USB_HRXS_BSERR_Set                   (uint32_t)(1 << USB_HRXS_BSERR_OFFS)
#define USB_HRXS_BSERR_Reset                 (uint32_t)(1 << (USB_HRXS_BSERR_OFFS + 16))

#define USB_HRXS_RXOF_Set                    (uint32_t)(1 << USB_HRXS_RXOF_OFFS)
#define USB_HRXS_RXOF_Reset                  (uint32_t)(1 << (USB_HRXS_RXOF_OFFS + 16))

#define USB_HRXS_RXTO_Set                    (uint32_t)(1 << USB_HRXS_RXTO_OFFS)
#define USB_HRXS_RXTO_Reset                  (uint32_t)(1 << (USB_HRXS_RXTO_OFFS + 16))

#define USB_HRXS_NAKRXED_Set                 (uint32_t)(1 << USB_HRXS_NAKRXED_OFFS)
#define USB_HRXS_NAKRXED_Reset               (uint32_t)(1 << (USB_HRXS_NAKRXED_OFFS + 16))

#define USB_HRXS_STALLRXED_Set               (uint32_t)(1 << USB_HRXS_STALLRXED_OFFS)
#define USB_HRXS_STALLRXED_Reset             (uint32_t)(1 << (USB_HRXS_STALLRXED_OFFS + 16))

#define USB_HRXS_ACKRXED_Set                 (uint32_t)(1 << USB_HRXS_ACKRXED_OFFS)
#define USB_HRXS_ACKRXED_Reset               (uint32_t)(1 << (USB_HRXS_ACKRXED_OFFS + 16))

#define USB_HRXS_DATASEQ_Data1               (uint32_t)(1 << USB_HRXS_DATASEQ_OFFS)
#define USB_HRXS_DATASEQ_Data0               (uint32_t)(1 << (USB_HRXS_DATASEQ_OFFS + 16))
...
#define USB_SEPx_CTRL_EPEN_Enable            (uint32_t)(1 << USB_SEP_CTRL_EPEN_OFFS)
#define USB_SEPx_CTRL_EPEN_Disable           (uint32_t)(1 << (USB_SEP_CTRL_EPEN_OFFS + 16))

#define USB_SEPx_CTRL_EPRDY_Ready            (uint32_t)(1 << USB_SEP_CTRL_EPRDY_OFFS)
#define USB_SEPx_CTRL_EPRDY_NotReady         (uint32_t)(1 << (USB_SEP_CTRL_EPRDY_OFFS + 16))

#define USB_SEPx_CTRL_EPDATASEQ_Data1        (uint32_t)(1 << USB_SEP_CTRL_EPDATASEQ_OFFS)
#define USB_SEPx_CTRL_EPDATASEQ_Data0        (uint32_t)(1 << (USB_SEP_CTRL_EPDATASEQ_OFFS + 16))

#define USB_SEPx_CTRL_EPSSTALL_Reply         (uint32_t)(1 << USB_SEP_CTRL_EPSSTALL_OFFS)
#define USB_SEPx_CTRL_EPSSTALL_NotReply      (uint32_t)(1 << (USB_SEP_CTRL_EPSSTALL_OFFS + 16))

#define USB_SEPx_CTRL_EPISOEN_Set            (uint32_t)(1 << USB_SEP_CTRL_EPISOEN_OFFS)
#define USB_SEPx_CTRL_EPISOEN_Reset          (uint32_t)(1 << (USB_SEP_CTRL_EPISOEN_OFFS + 16))
...
#define USB_SEPx_STS_SCCRCERR_Set            (uint32_t)(1 << USB_SEP_STS_SCCRCERR_OFFS)
#define USB_SEPx_STS_SCCRCERR_Reset          (uint32_t)(1 << (USB_SEP_STS_SCCRCERR_OFFS + 16))

#define USB_SEPx_STS_SCBSERR_Set             (uint32_t)(1 << USB_SEP_STS_SCBSERR_OFFS)
#define USB_SEPx_STS_SCBSERR_Reset           (uint32_t)(1 << (USB_SEP_STS_SCBSERR_OFFS + 16))

#define USB_SEPx_STS_SCRXOF_Set              (uint32_t)(1 << USB_SEP_STS_SCRXOF_OFFS)
#define USB_SEPx_STS_SCRXOF_Reset            (uint32_t)(1 << (USB_SEP_STS_SCRXOF_Pos + 16))

#define USB_SEPx_STS_SCRXTO_Set              (uint32_t)(1 << USB_SEP_STS_SCRXTO_OFFS)
#define USB_SEPx_STS_SCRXTO_Reset            (uint32_t)(1 << (USB_SEP_STS_SCRXTO_OFFS + 16))

#define USB_SEPx_STS_SCNAKSENT_Set            (uint32_t)(1 << USB_SEP_STS_SCNAKSENT_OFFS)
#define USB_SEPx_STS_SCNAKSENT_Reset         (uint32_t)(1 << (USB_SEP_STS_SCNAKSENT_OFFS + 16))

#define USB_SEPx_STS_SCSTALLSENT_Set         (uint32_t)(1 << USB_SEP_STS_SCSTALLSENT_OFFS)
#define USB_SEPx_STS_SCSTALLSENT_Reset       (uint32_t)(1 << (USB_SEP_STS_SCSTALLSENT_OFFS + 16))

#define USB_SEPx_STS_SCACKRXED_Set           (uint32_t)(1 << USB_SEP_STS_SCACKRXED_OFFS)
#define USB_SEPx_STS_SCACKRXED_Reset         (uint32_t)(1 << (USB_SEP_STS_SCACKRXED_OFFS + 16))

#define USB_SEPx_STS_SCDATASEQ_Data1         (uint32_t)(1 << USB_SEP_STS_SCDATASEQ_OFFS)
#define USB_SEPx_STS_SCDATASEQ_Data0         (uint32_t)(1 << (USB_SEP_STS_SCDATASEQ_OFFS + 16))
...
#define USB_SC_SCGEN_Set                     (uint32_t)(1 << USB_SC_SCGEN_OFFS)
#define USB_SC_SCGEN_Reset                   (uint32_t)(1 << (USB_SC_SCGEN_OFFS + 16))

#define USB_SC_SCTXLS_DM_Set                 (uint32_t)(1 << USB_SC_SCTXLS_OFFS)
#define USB_SC_SCTXLS_DM_Reset               (uint32_t)(1 << (USB_SC_SCTXLS_OFFS + 16))

#define USB_SC_SCTXLS_DP_Set                 (uint32_t)(1 << (USB_SC_SCTXLS_OFFS + 1))
#define USB_SC_SCTXLS_DP_Reset               (uint32_t)(1 << (USB_SC_SCTXLS_OFFS + 16 + 1))

#define USB_SC_SCDC_Direct                   (uint32_t)(1 << USB_SC_SCDC_OFFS)
#define USB_SC_SCDC_Normal                   (uint32_t)(1 << (USB_SC_SCDC_OFFS + 16))

#define USB_SC_SCFSP_Full                    (uint32_t)(1 << USB_SC_SCFSP_OFFS)
#define USB_SC_SCFSP_Low                     (uint32_t)(1 << (USB_SC_SCFSP_OFFS + 16))

#define USB_SC_SCFSR_12Mb                    (uint32_t)(1 << USB_SC_SCFSR_OFFS)
#define USB_SC_SCFSR_1_5Mb                   (uint32_t)(1 << (USB_SC_SCFSR_OFFS + 16))
...
#define USB_SIM_SCTDONEIE_Set                (uint32_t)(1 << USB_SIM_SCTDONEIE_OFFS)
#define USB_SIM_SCTDONEIE_Reset              (uint32_t)(1 << (USB_SIM_SCTDONEIE_OFFS + 16))

#define USB_SIM_SCRESUMEIE_Set               (uint32_t)(1 << USB_SIM_SCRESUMEIE_OFFS)
#define USB_SIM_SCRESUMEIE_Reset             (uint32_t)(1 << (USB_SIM_SCRESUMEIE_OFFS + 16))

#define USB_SIM_SCRESETEVIE_Set              (uint32_t)(1 << USB_SIM_SCRESETEVIE_OFFS)
#define USB_SIM_SCRESETEVIE_Reset            (uint32_t)(1 << (USB_SIM_SCRESETEVIE_OFFS + 16))

#define USB_SIM_SCSOFRECIE_Set               (uint32_t)(1 << USB_SIM_SCSOFRECIE_OFFS)
#define USB_SIM_SCSOFRECIE_Reset             (uint32_t)(1 << (USB_SIM_SCSOFRECIE_OFFS + 16))

#define USB_SIM_SCNAKSENTIE_Set              (uint32_t)(1 << USB_SIM_SCNAKSENTIE_OFFS)
#define USB_SIM_SCNAKSENTIE_Reset            (uint32_t)(1 << (USB_SIM_SCNAKSENTIE_OFFS + 16))
