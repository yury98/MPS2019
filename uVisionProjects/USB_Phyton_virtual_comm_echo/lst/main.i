...
{
  ((RST_CLK_TypeDef *)0x40020000 )->PER_CLOCK=0xFFFFFFFF;
  VCom_Configuration();

   
  USB_CDC_Init(Buffer, 1, SET);

  ((EEPROM_TypeDef *)0x40018000 )->CMD=0<<3;
...
void Setup_CPU_Clock(void)
{
  ...
  RST_CLK_CPU_PLLconfig(((uint32_t)0x00000003), ((uint32_t)0x00000003));
...
void Setup_USB(void)
{
  ...
  USB_Clock_InitStruct.USB_USBC1_Source = ((uint32_t)0x00000002);
  USB_Clock_InitStruct.USB_PLLUSBMUL    = ((uint32_t)0x00000005);
