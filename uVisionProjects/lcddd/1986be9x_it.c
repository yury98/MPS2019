...
char extern FlashFlag;
char extern RamFlag;
char extern EthFlag;
uint32_t extern FlashResult;
char extern TestFlashDone;
uint32_t extern RamResult;
char extern TestRamDone;
uint32_t extern EthResult;
char extern TestEthDone;
...
int i;
	...
	{
		LcdPutString (module_string, 3); LcdPutChar (sym_sp, 15, 3);
		LcdPutString (flash_string, 4); LcdPutChar (sym_sp, 15, 4);
		if (TestFlashDone == 1 && FlashResult == 0) 
		{
			LcdPutString (pass_string, 5); LcdPutChar (sym_sp, 15, 5);
		}
		else
		if (TestFlashDone == 1 && FlashResult != 0)
		{
			LcdPutString (fail_string, 5); LcdPutChar (sym_sp, 15, 5);
		}
		else 
		if (TestFlashDone == 0) 
		{
	...
	{
		LcdPutString (module_string, 3); LcdPutChar (sym_sp, 15, 3);
		LcdPutString (ram_string, 4); LcdPutChar (sym_sp, 15, 4);
		if (TestRamDone == 1 && RamResult == 0) 
		{
			LcdPutString (pass_string, 5); LcdPutChar (sym_sp, 15, 5);
		}
		else
	...
	{
		LcdPutString (module_string, 3); LcdPutChar (sym_sp, 15, 3);
		LcdPutString (eth_string, 4); LcdPutChar (sym_sp, 15, 4);
		if (TestEthDone == 1 && EthResult == 0) 
		{
			LcdPutString (pass_string, 5); LcdPutChar (sym_sp, 15, 5);
		}
		else
