...
#endif /* (USE_1986BE91_Rev0) || defined (USE_1986BE91_Rev1) */
...
static PORT_TypeDef PORTB_Configuration;
#endif /* defined (USE_1986BE92Y_Rev0) || defined (USE_1986BE92Y_Rev1) */
...
{
  PORTB_Configuration.ANALOG = PORTB->ANALOG;
  PORTB_Configuration.FUNC   = PORTB->FUNC;
  PORTB_Configuration.GFEN   = PORTB->GFEN;
  PORTB_Configuration.OE     = PORTB->OE;
  PORTB_Configuration.PD     = PORTB->PD;
  PORTB_Configuration.PULL   = PORTB->PULL;
  PORTB_Configuration.PWR    = PORTB->PWR;
}
...
{
  PORTB->ANALOG = PORTB_Configuration.ANALOG;
  PORTB->FUNC   = PORTB_Configuration.FUNC;
  PORTB->GFEN   = PORTB_Configuration.GFEN;
  PORTB->OE     = PORTB_Configuration.OE;
  PORTB->PD     = PORTB_Configuration.PD;
  PORTB->PULL   = PORTB_Configuration.PULL;
  PORTB->PWR    = PORTB_Configuration.PWR;
}
#endif /* defined (USE_1986BE92Y_Rev0) || defined (USE_1986BE92Y_Rev1) */
...
static void UARTConfiguration(void)
{
  ...
  PORT_Init(PORTF, &PortInitStructure);
#else
#if defined (USE_1986BE92Y_Rev0) && !defined (USE_1986BE92Y_Rev1)
  PORTBSaveConfig();
#endif /* defined (USE_1986BE92Y_Rev0) && !defined (USE_1986BE92Y_Rev1) */
  ...
  PortInitStructure.PORT_SPEED = PORT_SPEED_MAXFAST;
  PORT_Init(PORTB, &PortInitStructure);
#endif /* defined (USE_1986BE91_Rev0) || defined (USE_1986BE91_Rev1) */
...
void VCOMFunc(void) {
  ...
  temp_CPU_CLOCK   = RST_CLK->CPU_CLOCK;
  temp_PLL_CONTROL = RST_CLK->PLL_CONTROL;
...
/*  UARTInitStructure.UART_HardwareFlowControl     |= UART_HardwareFlowControl_LBE; */
  ...
  RST_CLK->CPU_CLOCK   = temp_CPU_CLOCK;
  RST_CLK->PLL_CONTROL = temp_PLL_CONTROL;
