...
#define LEDs_PORT       PORTD                          /*!< LEDs port for 1986BE91 evaluation board */
#define LEDs_PINs       (PORT_Pin_10 | PORT_Pin_11 | \
                         PORT_Pin_12 | PORT_Pin_13 | \
                         PORT_Pin_14)                  /*!< LEDs pins for 1986BE91 evaluation board */
#define NUM_LEDs        5                              /*!< Number of LEDs on 1986BE91 evaluation board */
#define LEDs_OFS        10                             /*!< Offset of first LED pin in the port (for 1986BE91 evaluation board) */
...
#elif defined (USE_1986BE93Y_Rev0)
#define LEDs_PORT       PORTF
#define LEDs_PINs       (PORT_Pin_0 | PORT_Pin_1)
#define NUM_LEDs        2
#define LEDs_OFS        0

#elif defined (USE_1986BE93Y_Rev1)
