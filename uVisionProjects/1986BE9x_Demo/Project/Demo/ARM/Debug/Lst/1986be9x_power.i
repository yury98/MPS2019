#line 1 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_power.c"
...
#line 24 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_power.c"
...
#line 25 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_power.c"
...
#line 26 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_power.c"
...
void POWER_DeInit(void)
{
  ((POWER_TypeDef*) 0x40058000) -> PVDCS = (uint32_t) 0x00000000;
}
...
void POWER_DUccMode(uint32_t DUccMode)
{
  ...
  tmpreg  = ((BKP_TypeDef*) 0x400D8000) -> REG_0E & (uint32_t) (~((uint32_t)(((uint32_t)0x00000007) | ((uint32_t)0x00000038))));
   
  tmpreg |= ((uint32_t)(((uint32_t)0x00000007) | ((uint32_t)0x00000038))) & DUccMode;
  ((BKP_TypeDef*) 0x400D8000) -> REG_0E = tmpreg;
}
...
void POWER_DUccTrim(uint32_t DUccTrim)
{
  ...
  tmpreg  = ((BKP_TypeDef*) 0x400D8000) -> REG_0E & (uint32_t) (~((uint32_t)((uint32_t)0x00000700)));
...
void POWER_DUccStandby(void)
{
  *(volatile uint32_t *) (0x42000000 + ((uint32_t)&((BKP_TypeDef*)(0x400D8000 - 0x40000000))->REG_0F)*32 + 30*4) = (uint32_t) 0x01;
}
...
void POWER_SetFlagPOR(void)
{
  *(volatile uint32_t *) (0x42000000 + ((uint32_t)&((BKP_TypeDef*)(0x400D8000 - 0x40000000))->REG_0E)*32 + 11*4) = (uint32_t) 0x01;
}
...
ErrorStatus POWER_FlagPORstatus(void)
{
  ...
  if (*(volatile uint32_t *) (0x42000000 + ((uint32_t)&((BKP_TypeDef*)(0x400D8000 - 0x40000000))->REG_0E)*32 + 11*4) == 0)
  {
    state = SUCCESS;
  }
  return state;
...
void POWER_PVDenable(FunctionalState NewState)
{
  ...
  ((void)0);
  *(volatile uint32_t *) (0x42000000 + ((uint32_t)&((POWER_TypeDef*)(0x40058000 - 0x40000000))->PVDCS)*32 + 0*4) = (uint32_t)NewState;
}
...
FlagStatus POWER_GetFlagStatus(uint32_t POWER_FLAG)
{
  ...
  if ((((POWER_TypeDef*) 0x40058000)->PVDCS & POWER_FLAG) != (uint32_t)RESET)
  {
    status = SET;
  }
  else
...
void POWER_ClearFlag(uint32_t POWER_FLAG)
{
  ...
  ((POWER_TypeDef*) 0x40058000)->PVDCS &= (uint32_t) ~POWER_FLAG;
}
...
void POWER_PVD_ITconfig(uint32_t POWER_IT, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ((POWER_TypeDef*) 0x40058000)->PVDCS |= POWER_IT;
  }
  else
  {
    ((POWER_TypeDef*) 0x40058000)->PVDCS &= (uint32_t)~POWER_IT;
  }
}
...
void POWER_PVD_INVconfig(uint32_t POWER_INV, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ((POWER_TypeDef*) 0x40058000)->PVDCS |= POWER_INV;
  }
  else
  {
    ((POWER_TypeDef*) 0x40058000)->PVDCS &= (uint32_t)~POWER_INV;
  }
}
...
void POWER_EnterSTOPMode(FunctionalState POWER_Regulator_state, uint8_t POWER_STOPentry)
{
   ...
   *(volatile uint32_t *) (0x42000000 + ((uint32_t)&((BKP_TypeDef*)(0x400D8000 - 0x40000000))->REG_0F)*32 + 30*4) = (uint32_t) (!POWER_Regulator_state);
