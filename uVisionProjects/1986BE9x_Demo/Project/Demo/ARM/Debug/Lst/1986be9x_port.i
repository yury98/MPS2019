#line 1 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_port.c"
...
#line 25 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_port.c"
#line 26 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_port.c"
...
void PORT_Init(PORT_TypeDef* PORTx, const PORT_InitTypeDef* PORT_InitStruct)
{
  ...
  PORTx->OE     = tmpreg_OE & (~(((PORTx) == ((PORT_TypeDef*) 0x400B0000)) ? 0x001FU : 0));
  PORTx->FUNC   = tmpreg_FUNC & (~(((PORTx) == ((PORT_TypeDef*) 0x400B0000)) ? 0x001FU : 0));
  PORTx->ANALOG = tmpreg_ANALOG & (~(((PORTx) == ((PORT_TypeDef*) 0x400B0000)) ? 0x001FU : 0));
  PORTx->PULL   = tmpreg_PULL & (~(((PORTx) == ((PORT_TypeDef*) 0x400B0000)) ? 0x001FU : 0));
  PORTx->PD     = tmpreg_PD & (~(((PORTx) == ((PORT_TypeDef*) 0x400B0000)) ? 0x001FU : 0));
  PORTx->PWR    = tmpreg_PWR & (~(((PORTx) == ((PORT_TypeDef*) 0x400B0000)) ? 0x001FU : 0));
  PORTx->GFEN   = tmpreg_GFEN & (~(((PORTx) == ((PORT_TypeDef*) 0x400B0000)) ? 0x001FU : 0));
}
...
void PORT_SetBits(PORT_TypeDef* PORTx, uint32_t PORT_Pin)
{
  ...
  PORTx->RXTX = PORT_Pin | (PORTx->RXTX & (~(((PORTx) == ((PORT_TypeDef*) 0x400B0000)) ? 0x001FU : 0)));
}
...
void PORT_ResetBits(PORT_TypeDef* PORTx, uint32_t PORT_Pin)
{
  ...
  PORTx->RXTX &= ~(PORT_Pin | (((PORTx) == ((PORT_TypeDef*) 0x400B0000)) ? 0x001FU : 0));
}
...
void PORT_WriteBit(PORT_TypeDef* PORTx, uint32_t PORT_Pin, BitAction BitVal)
{
  ...
  portdata = PORTx->RXTX & (~(((PORTx) == ((PORT_TypeDef*) 0x400B0000)) ? 0x001FU : 0));
  if (BitVal != Bit_RESET)
  {
...
void PORT_Write(PORT_TypeDef* PORTx, uint32_t PortVal)
{
  ...
  PORTx->RXTX = PortVal & (~(((PORTx) == ((PORT_TypeDef*) 0x400B0000)) ? 0x001FU : 0));
}
