#line 1 "..\\..\\src\\Demo_Init_1986BE91.c"
...
#line 23 "..\\..\\src\\Demo_Init_1986BE91.c"
...
#line 24 "..\\..\\src\\Demo_Init_1986BE91.c"
...
#line 25 "..\\..\\src\\Demo_Init_1986BE91.c"
...
#line 26 "..\\..\\src\\Demo_Init_1986BE91.c"
...
#line 27 "..\\..\\src\\Demo_Init_1986BE91.c"
#line 1 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_ext_bus.h"
...
#line 30 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_ext_bus.h"
#line 31 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_ext_bus.h"
...
typedef struct
{
  uint32_t EXT_BUS_Mode;        
 
  uint32_t EXT_BUS_Cpol;        
 
  uint8_t  EXT_BUS_WaitState;   
 
  uint8_t  EXT_BUS_NandTrc;     
 
  uint8_t  EXT_BUS_NandTwc;     
 
  uint8_t  EXT_BUS_NandTrea;    
 
  uint8_t  EXT_BUS_NandTwp;     
 
  uint8_t  EXT_BUS_NandTwhr;    
 
  uint8_t  EXT_BUS_NandTalea;   
 
  uint8_t  EXT_BUS_NandTrr;     
...
#line 128 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_ext_bus.h"
...
#line 155 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_ext_bus.h"
...
#line 28 "..\\..\\src\\Demo_Init_1986BE91.c"
...
#line 29 "..\\..\\src\\Demo_Init_1986BE91.c"
#line 1 "..\\..\\Inc\\lcd.h"
...
#line 30 "..\\..\\src\\Demo_Init_1986BE91.c"
#line 1 "..\\..\\Inc\\leds.h"
...
#line 31 "..\\..\\src\\Demo_Init_1986BE91.c"
...
#line 32 "..\\..\\src\\Demo_Init_1986BE91.c"
...
void ExtBus_Setup(void)
{
  ...
  RST_CLK_PCLKcmd(((uint32_t)(1 << ((((uint32_t)0x400F0000) >> 15) & 0x1F))), ENABLE);

  EXT_BUS_StructInit(&EXT_BUS_InitStruct);

   
  EXT_BUS_InitStruct.EXT_BUS_WaitState = ((uint32_t)0x9);
  EXT_BUS_InitStruct.EXT_BUS_Mode      = (((uint32_t)0x1) << 0);
...
void ClockConfigure(void)
{
  ...
  RST_CLK_CPU_PLLconfig (((uint32_t)0x00000001),0);

   
  RST_CLK_PCLKcmd((((uint32_t)(1 << ((((uint32_t)0x400A8000) >> 15) & 0x1F))) | ((uint32_t)(1 << ((((uint32_t)0x400B0000) >> 15) & 0x1F))) | ((uint32_t)(1 << ((((uint32_t)0x400B8000) >> 15) & 0x1F))) | ((uint32_t)(1 << ((((uint32_t)0x400C0000) >> 15) & 0x1F))) | ((uint32_t)(1 << ((((uint32_t)0x400C8000) >> 15) & 0x1F))) | ((uint32_t)(1 << ((((uint32_t)0x400E8000) >> 15) & 0x1F)))), ENABLE);
}
...
void Demo_Init(void)
{
  ...
  PortInitStructure.PORT_Pin = (0x0001U | 0x0002U | 0x0004U | 0x0008U | 0x0010U | 0x0020U | 0x0040U | 0x0080U);
  ...
  PORT_Init(((PORT_TypeDef*) 0x400A8000), &PortInitStructure);

   
  PortInitStructure.PORT_Pin = 0x0010U | 0x0020U;

  PORT_Init(((PORT_TypeDef*) 0x400C8000), &PortInitStructure);

   
  PortInitStructure.PORT_Pin = 0x0800U;

  PORT_Init(((PORT_TypeDef*) 0x400C8000), &PortInitStructure);

   
  PortInitStructure.PORT_Pin = 0x0004U;

  PORT_Init(((PORT_TypeDef*) 0x400B8000), &PortInitStructure);

   
  PortInitStructure.PORT_Pin = 0x0080U;
  PortInitStructure.PORT_SPEED = PORT_SPEED_FAST;

  PORT_Init(((PORT_TypeDef*) 0x400B8000), &PortInitStructure);

   
  PortInitStructure.PORT_Pin = 0x0200U;
  ...
  PortInitStructure.PORT_Pin   = (0x0400U | 0x0800U | 0x1000U |
                                  0x2000U | 0x4000U);
  PortInitStructure.PORT_OE    = PORT_OE_IN;
  PortInitStructure.PORT_FUNC  = PORT_FUNC_PORT;
  ...
  PortInitStructure.PORT_Pin   = (0x0400U | 0x0800U | 0x1000U | 0x2000U | 0x4000U);
  PortInitStructure.PORT_OE    = PORT_OE_OUT;
  PortInitStructure.PORT_FUNC  = PORT_FUNC_PORT;
  PortInitStructure.PORT_SPEED = PORT_SPEED_SLOW;

  PORT_Init(((PORT_TypeDef*) 0x400C0000), &PortInitStructure);
