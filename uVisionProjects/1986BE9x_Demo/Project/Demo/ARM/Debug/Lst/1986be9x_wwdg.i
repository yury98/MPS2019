#line 1 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_wwdg.c"
...
#line 1 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_wwdg.h"
...
#line 30 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_wwdg.h"
...
#line 31 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_wwdg.h"
...
#line 64 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_wwdg.h"
...
#line 24 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_wwdg.c"
...
#line 25 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_wwdg.c"
...
#line 26 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_wwdg.c"
...
void WWDG_DeInit(void)
{
  RST_CLK_PCLKcmd(((uint32_t)(1 << ((((uint32_t)0x40060000) >> 15) & 0x1F))), ENABLE);
  RST_CLK_PCLKcmd(((uint32_t)(1 << ((((uint32_t)0x40060000) >> 15) & 0x1F))), DISABLE);
}
...
void WWDG_SetPrescaler(uint32_t WWDG_Prescaler)
{
  ...
  tmpreg = ((WWDG_TypeDef*) 0x40060000)->CFR & ((uint32_t)0xFFFFFE7F);
   
  tmpreg |= WWDG_Prescaler;
   
  ((WWDG_TypeDef*) 0x40060000)->CFR = tmpreg;
}
...
void WWDG_SetWindowValue(uint32_t WindowValue)
{
  ...
  tmpreg = ((WWDG_TypeDef*) 0x40060000)->CFR & (uint32_t) (~((uint32_t)0x7F));

   
  tmpreg |= WindowValue & (uint32_t) ((uint32_t)0x7F);
...
void WWDG_EnableIT(void)
{
  *(volatile uint32_t *) (0x42000000 + ((uint32_t)&((WWDG_TypeDef*)(0x40060000 - 0x40000000))->CFR)*32 + 9*4) = (uint32_t)ENABLE;
}
...
void WWDG_SetCounter(uint32_t Counter)
{
  ...
  ((WWDG_TypeDef*) 0x40060000)->CR = Counter & ((uint32_t)0x7F);
}
...
void WWDG_Enable(uint32_t Counter)
{
  ...
  ((void)0);
  ((WWDG_TypeDef*) 0x40060000)->CR = ((uint32_t)0x00000080) | Counter;
}
...
FlagStatus WWDG_GetFlagStatus(void)
{
  return (FlagStatus)(((WWDG_TypeDef*) 0x40060000)->SR);
}
...
void WWDG_ClearFlag(void)
{
  ((WWDG_TypeDef*) 0x40060000)->SR = (uint32_t)RESET;
}
