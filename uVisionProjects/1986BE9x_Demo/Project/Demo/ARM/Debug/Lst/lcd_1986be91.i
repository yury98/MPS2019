...
const LCD_Ports CrystalPorts[NUM_LCD_CRYSTALS] = {
  ...
  { 0x10000000 + 0x100000 + 0x8000000,
    0x10000000 + 0x100000 },
   
  { 0x10000000 + 0x200000 + 0x8000000,
    0x10000000 + 0x200000 }
};

 
LCD_Crystal CurrentCrystal = LCD_CRYSTAL1;   
LCD_Method CurrentMethod = MET_AND;          
...
void ResetLCD(void)
{
  PORT_SetBits(((PORT_TypeDef*) 0x400B8000), 0x0200U);
  PORT_ResetBits(((PORT_TypeDef*) 0x400B8000), 0x0200U);
  Pause();
  PORT_SetBits(((PORT_TypeDef*) 0x400B8000), 0x0200U);
  WhileStatus((uint32_t)(1 << 7) | (uint32_t)(1 << 4));
}
...
void SetCrystal(LCD_Crystal num)
{
  PORT_Write(((PORT_TypeDef*) 0x400C8000), ((num + 1) << 4));
...
void WriteLCD_Cmd(uint32_t val)
{
  (*((vuint32_t*)CrystalPorts[CurrentCrystal]. Cmd)) = val;
  WhileStatus((uint32_t)(1 << 7));
}
...
void WriteLCD_Data(uint32_t val)
{
  (*((vuint32_t*)CrystalPorts[CurrentCrystal]. Data)) = val;
  WhileStatus((uint32_t)(1 << 7));
}
...
uint32_t ReadLCD_Cmd(void)
{
  uint32_t ret = (*((vuint32_t*)CrystalPorts[CurrentCrystal]. Cmd));
...
{
  uint32_t ret;
  (*((vuint32_t*)CrystalPorts[CurrentCrystal]. Data));      
  WhileStatus((uint32_t)(1 << 7));
  ret = (*((vuint32_t*)CrystalPorts[CurrentCrystal]. Data));
  WhileStatus((uint32_t)(1 << 7));
  return ret;
}
