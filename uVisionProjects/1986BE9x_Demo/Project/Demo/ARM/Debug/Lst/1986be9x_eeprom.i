#line 1 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_eeprom.c"
...
#line 1 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_eeprom.h"
...
#line 30 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_eeprom.h"
...
#line 61 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_eeprom.h"
...
#line 128 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_eeprom.h"
...
#line 25 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_eeprom.c"
...
#line 26 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_eeprom.c"
 ...
 uint8_t EEPROM_ReadByte(uint32_t Address, uint32_t BankSelector)
{
  ...
  ((EEPROM_TypeDef*) 0x40018000)->KEY = ((uint32_t)0x8AAA5551);
  Command = (((EEPROM_TypeDef*) 0x40018000)->CMD & ((uint32_t)0x00000038)) | ((uint32_t)0x00000001);
  Command |= (BankSelector == ((uint32_t)0x00000001)) ? ((uint32_t)0x00000200) : 0;
  ((EEPROM_TypeDef*) 0x40018000)->CMD = Command;
  ((EEPROM_TypeDef*) 0x40018000)->ADR = Address;
  ((EEPROM_TypeDef*) 0x40018000)->CMD = Command | ((uint32_t)0x00000040) | ((uint32_t)0x00000080) | ((uint32_t)0x00000100);
  ((EEPROM_TypeDef*) 0x40018000)->DO;    
  ((EEPROM_TypeDef*) 0x40018000)->DO;    
  ((EEPROM_TypeDef*) 0x40018000)->DO;    
  Data = ((EEPROM_TypeDef*) 0x40018000)->DO;
  Command &= ((uint32_t)0x00000038);
  ((EEPROM_TypeDef*) 0x40018000)->CMD = Command;
  ((EEPROM_TypeDef*) 0x40018000)->KEY = 0;
 ...
 void EEPROM_ErasePage(uint32_t Address, uint32_t BankSelector)
{
  ...
  {
    ((EEPROM_TypeDef*) 0x40018000)->ADR = Address + Offset;              
    ((EEPROM_TypeDef*) 0x40018000)->DI = 0;
 ...
 void EEPROM_EraseAllPages(uint32_t BankSelector)
{
  ...
  for (Offset = 0; Offset < (4 << 2); Offset += 4)
  {
    ((EEPROM_TypeDef*) 0x40018000)->ADR = Offset;
    ((EEPROM_TypeDef*) 0x40018000)->DI = 0;
 ...
 void EEPROM_ProgramWord(uint32_t Address, uint32_t BankSelector, uint32_t Data)
{
  ...
  Command = ((EEPROM_TypeDef*) 0x40018000)->CMD & ((uint32_t)0x00000038);
  Command |= ((uint32_t)0x00000001) | BankSelector;
  ((EEPROM_TypeDef*) 0x40018000)->CMD = Command;
  ((EEPROM_TypeDef*) 0x40018000)->ADR = Address;
  ((EEPROM_TypeDef*) 0x40018000)->DI  = Data;
  ...
  ((EEPROM_TypeDef*) 0x40018000)->CMD = Command & ((uint32_t)0x00000038);
  ((EEPROM_TypeDef*) 0x40018000)->KEY = 0;
}
