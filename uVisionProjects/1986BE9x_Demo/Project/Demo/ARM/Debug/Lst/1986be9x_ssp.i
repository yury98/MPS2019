#line 1 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_ssp.c"
...
#line 1 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_ssp.h"
...
#line 30 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_ssp.h"
...
#line 31 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_ssp.h"
...
#line 115 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_ssp.h"

#line 129 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_ssp.h"
...
#line 247 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_ssp.h"
...
void SSP_Init(SSP_TypeDef* SSPx, const SSP_InitTypeDef* SSP_InitStruct);
...
ITStatus SSP_GetITStatusMasked(SSP_TypeDef* SSPx, uint32_t SSP_IT);
...
void SSP_BRGInit(SSP_TypeDef* SSPx, uint32_t SSP_BRG);
...
#line 25 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_ssp.c"
...
#line 26 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_ssp.c"
...
#line 27 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_ssp.c"
...
void SSP_BRGInit(SSP_TypeDef* SSPx, uint32_t SSP_BRG)
{
  ...
  tmpreg = ((RST_CLK_TypeDef*) 0x40020000)->SSP_CLOCK;

  if (SSPx == ((SSP_TypeDef*) 0x40040000))
  {
    tmpreg |= ((uint32_t)0x01000000);
    tmpreg &= ~((uint32_t)0x000000FF);
    tmpreg |= SSP_BRG;
  }
  else if (SSPx == ((SSP_TypeDef*) 0x400A0000))
  {
    tmpreg |= ((uint32_t)0x02000000);
    tmpreg &= ~((uint32_t)0x0000FF00);
    tmpreg |= (SSP_BRG << 8);
  }
  ((RST_CLK_TypeDef*) 0x40020000)->SSP_CLOCK = tmpreg;
}
