#line 1 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_ext_bus.c"
...
#line 25 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_ext_bus.c"
...
#line 26 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_ext_bus.c"
...
void EXT_BUS_DeInit(void)
{
  ...
  EXT_BUSx = ((EXT_BUS_TypeDef*) 0x400F0000);
...
void EXT_BUS_Init(const EXT_BUS_InitTypeDef* EXT_BUS_InitStruct)
{
  ...
  tmpreg_CONTROL = (EXT_BUS_InitStruct->EXT_BUS_Mode)
                 ...
                 | (EXT_BUS_InitStruct->EXT_BUS_WaitState << 12);

   
  tmpreg_CYCLES  = (EXT_BUS_InitStruct->EXT_BUS_NandTrc   << 0)
                 | (EXT_BUS_InitStruct->EXT_BUS_NandTwc   << 4)
                 | (EXT_BUS_InitStruct->EXT_BUS_NandTrea  << 8)
                 | (EXT_BUS_InitStruct->EXT_BUS_NandTwp   << 12)
                 | (EXT_BUS_InitStruct->EXT_BUS_NandTwhr  << 16)
                 | (EXT_BUS_InitStruct->EXT_BUS_NandTalea << 20)
                 | (EXT_BUS_InitStruct->EXT_BUS_NandTrr   << 24);
...
void EXT_BUS_StructInit(EXT_BUS_InitTypeDef* EXT_BUS_InitStruct)
{
  ...
  EXT_BUS_InitStruct->EXT_BUS_Mode      = ((uint32_t)0x0);
  EXT_BUS_InitStruct->EXT_BUS_Cpol      = (((uint32_t)0x0) << 3);
  EXT_BUS_InitStruct->EXT_BUS_WaitState = ((uint32_t)0x0);
  EXT_BUS_InitStruct->EXT_BUS_NandTrc   = ((uint32_t)0x0);
  EXT_BUS_InitStruct->EXT_BUS_NandTwc   = ((uint32_t)0x0);
  EXT_BUS_InitStruct->EXT_BUS_NandTrea  = ((uint32_t)0x0);
  EXT_BUS_InitStruct->EXT_BUS_NandTwp   = ((uint32_t)0x0);
  EXT_BUS_InitStruct->EXT_BUS_NandTwhr  = ((uint32_t)0x0);
  EXT_BUS_InitStruct->EXT_BUS_NandTalea = ((uint32_t)0x0);
  EXT_BUS_InitStruct->EXT_BUS_NandTrr   = ((uint32_t)0x0);
}
...
FlagStatus EXT_BUS_GetBusyStatus(void)
{
  ...
  if ((EXT_BUSx->CONTROL & ((uint32_t)0x00000080)) == 0)
  {
