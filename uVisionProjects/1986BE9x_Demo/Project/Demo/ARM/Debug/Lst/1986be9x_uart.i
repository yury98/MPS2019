#line 1 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_uart.c"
...
#line 25 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_uart.c"
...
#line 26 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_uart.c"
...
#line 27 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_uart.c"
...
BaudRateStatus UART_Init(UART_TypeDef* UARTx, UART_InitTypeDef* UART_InitStruct)
{
  ...
  tmpreg = ((RST_CLK_TypeDef*) 0x40020000)->UART_CLOCK;

  if (UARTx == ((UART_TypeDef*) 0x40030000))
  {
    cpuclock /= (1 << (tmpreg & ((uint32_t)0x0007)));
  }
  else if (UARTx == ((UART_TypeDef*) 0x40038000))
  {
...
void UART_BRGInit(UART_TypeDef* UARTx, uint32_t UART_BRG)
{
  ...
  ((RST_CLK_TypeDef*) 0x40020000)->UART_CLOCK = tmpreg;
}
