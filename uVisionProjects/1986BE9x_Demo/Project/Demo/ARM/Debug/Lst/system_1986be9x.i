#line 1 "..\\..\\..\\Library\\Libraries\\CMSIS\\CM3\\DeviceSupport\\1986BE9x\\startup\\arm\\system_1986BE9x.c"
...
#line 37 "..\\..\\..\\Library\\Libraries\\CMSIS\\CM3\\DeviceSupport\\1986BE9x\\startup\\arm\\system_1986BE9x.c"
...
#line 38 "..\\..\\..\\Library\\Libraries\\CMSIS\\CM3\\DeviceSupport\\1986BE9x\\startup\\arm\\system_1986BE9x.c"
...
void SystemCoreClockUpdate (void)
{
  ...
  if ((((RST_CLK_TypeDef*) 0x40020000)->CPU_CLOCK & (uint32_t)0x00000002) == (uint32_t)0x00000002)
  {
  ...
  if ((((RST_CLK_TypeDef*) 0x40020000)->CPU_CLOCK & (uint32_t)0x00000001) == (uint32_t)0x00000001)
  {
    cpu_c1_freq /= 2;
  }
  ...
  if ((((RST_CLK_TypeDef*) 0x40020000)->CPU_CLOCK & (uint32_t)0x00000004) == (uint32_t)0x00000004)
  {
  ...
  switch ((((RST_CLK_TypeDef*) 0x40020000)->PLL_CONTROL >> 8) & (uint32_t)0x03)
  {
    case 0 :
    ...
    case 1 :
      ...
      cpu_c3_freq = cpu_c2_freq / ((((RST_CLK_TypeDef*) 0x40020000)->CPU_CLOCK >> 4 & (uint32_t)0x0F) + 1);
...
void SystemInit (void)
{
  ...
  ((RST_CLK_TypeDef*) 0x40020000)->PER_CLOCK   = (uint32_t)0x8000010;
