#line 1 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_iwdg.c"
...
#line 1 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_iwdg.h"
...
#line 30 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_iwdg.h"
...
#line 31 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_iwdg.h"
...
#line 68 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_iwdg.h"
...
#line 24 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_iwdg.c"
...
#line 25 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_iwdg.c"
...
void IWDG_WriteAccessEnable(void)
{
  ((IWDG_TypeDef*) 0x40068000)->KR = ((uint32_t)0x5555);
}
...
void IWDG_WriteAccessDisable(void)
{
  ((IWDG_TypeDef*) 0x40068000)->KR = ((uint32_t)0x0000);
}
...
void IWDG_SetPrescaler(uint32_t IWDG_Prescaler)
{
  ...
  ((void)0);
  ((IWDG_TypeDef*) 0x40068000)->PR = IWDG_Prescaler;
}
...
void IWDG_SetReload(uint32_t Reload)
{
  ...
  ((void)0);
  ((IWDG_TypeDef*) 0x40068000)->RLR = Reload;
}
...
void IWDG_ReloadCounter(void)
{
  ((IWDG_TypeDef*) 0x40068000)->KR = ((uint32_t)0xAAAA);
}
...
void IWDG_Enable(void)
{
  ((IWDG_TypeDef*) 0x40068000)->KR = ((uint32_t)0xCCCC);
}
...
FlagStatus IWDG_GetFlagStatus(uint32_t IWDG_FLAG)
{
  ...
  ((void)0);
  if ((((IWDG_TypeDef*) 0x40068000)->SR & IWDG_FLAG) != (uint32_t)RESET)
  {
    bitstatus = SET;
  }
  else
