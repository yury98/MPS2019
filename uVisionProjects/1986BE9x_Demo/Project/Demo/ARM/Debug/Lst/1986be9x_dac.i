#line 1 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_dac.c"
...
#line 1 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_dac.h"
...
#line 30 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_dac.h"
...
#line 31 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_dac.h"
...
#line 25 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_dac.c"
...
#line 26 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_dac.c"
...
void DAC_DeInit(void)
{
  ((DAC_TypeDef*) 0x40090000)->DAC1_DATA = 0;
  ((DAC_TypeDef*) 0x40090000)->DAC2_DATA = 0;
  ((DAC_TypeDef*) 0x40090000)->CFG = 0;
}
...
void DAC_Init(uint32_t SyncMode, uint32_t DAC1_Ref, uint32_t DAC2_Ref)
{
  ...
  tmpreg_CFG = ((DAC_TypeDef*) 0x40090000)->CFG;
  tmpreg_CFG &= ~(((uint32_t)0x00000010) | ((uint32_t)0x00000001) | ((uint32_t)0x00000002));
  tmpreg_CFG += SyncMode + DAC1_Ref + DAC2_Ref;
  ((DAC_TypeDef*) 0x40090000)->CFG = tmpreg_CFG;
}
...
void DAC1_SetData(uint32_t Data)
{
  ...
  ((DAC_TypeDef*) 0x40090000)->DAC1_DATA = Data;
}
...
void DAC2_SetData(uint32_t Data)
{
  ...
  ((DAC_TypeDef*) 0x40090000)->DAC2_DATA = Data;
}
...
uint32_t DAC1_GetData(void)
{
  return ((DAC_TypeDef*) 0x40090000)->DAC1_DATA;
}
...
uint32_t DAC2_GetData(void)
{
  return ((DAC_TypeDef*) 0x40090000)->DAC2_DATA;
}
