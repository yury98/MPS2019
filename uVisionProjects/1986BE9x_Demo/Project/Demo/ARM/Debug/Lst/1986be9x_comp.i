#line 1 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_comp.c"
...
#line 1 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_comp.h"
...
#line 30 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_comp.h"
...
#line 31 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_comp.h"
...
typedef struct
{
  uint32_t COMP_PlusInputSource;        
 

  uint32_t COMP_MinusInputSource;       
 

  uint32_t COMP_OutInversion;           
...
typedef struct
{
  uint32_t COMP_CVRefSource;            
 

  uint32_t COMP_CVRefRange;             
 

  uint32_t COMP_CVRefScale;             
...
#line 166 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_comp.h"

#line 183 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_comp.h"

#line 216 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_comp.h"
...
#line 25 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_comp.c"
...
#line 26 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_comp.c"
...
void COMP_DeInit(void)
{
  ((COMP_TypeDef*) 0x40098000)->CFG = 0;
  ((COMP_TypeDef*) 0x40098000)->RESULT_LATCH;
}
...
void COMP_Init(const COMP_InitTypeDef* COMP_InitStruct)
{
  ...
  tmpreg_CFG = ((COMP_TypeDef*) 0x40098000)->CFG;
  tmpreg_CFG &= ~(((uint32_t)0x00000100) | ((uint32_t)0x00000600) | ((uint32_t)0x00000800));
  tmpreg_CFG += COMP_InitStruct->COMP_PlusInputSource
              + COMP_InitStruct->COMP_MinusInputSource
              + COMP_InitStruct->COMP_OutInversion;
  ((COMP_TypeDef*) 0x40098000)->CFG = tmpreg_CFG;
}
...
void COMP_StructInit(COMP_InitTypeDef* COMP_InitStruct)
{
  COMP_InitStruct->COMP_PlusInputSource  = (((uint32_t)0x0) << 8);
  COMP_InitStruct->COMP_MinusInputSource = (((uint32_t)0x0) << 9);
  COMP_InitStruct->COMP_OutInversion     = (((uint32_t)0x0) << 11);
}
...
FlagStatus COMP_GetCfgFlagStatus(uint32_t Flag)
{
  ...
  if ((((COMP_TypeDef*) 0x40098000)->CFG & Flag) == 0)
  {
    bitstatus = RESET;
  }
  else
...
void COMP_PInpSourceConfig(uint32_t Source)
{
  ...
  tmpreg_CFG = ((COMP_TypeDef*) 0x40098000)->CFG;
  tmpreg_CFG &= ~((uint32_t)0x00000100);
  tmpreg_CFG += Source;
  ((COMP_TypeDef*) 0x40098000)->CFG = tmpreg_CFG;
}
...
void COMP_MInpSourceConfig(uint32_t Source)
{
  ...
  tmpreg_CFG = ((COMP_TypeDef*) 0x40098000)->CFG;
  tmpreg_CFG &= ~((uint32_t)0x00000600);
  tmpreg_CFG += Source;
  ((COMP_TypeDef*) 0x40098000)->CFG = tmpreg_CFG;
}
...
void COMP_OutInversionConfig(uint32_t Inversion)
{
  ...
  tmpreg_CFG = ((COMP_TypeDef*) 0x40098000)->CFG;
  tmpreg_CFG &= ~((uint32_t)0x00000800);
...
void COMP_CVRefInit(const COMP_CVRefInitTypeDef* COMP_CVRefInitStruct)
{
  ...
  tmpreg_CFG = ((COMP_TypeDef*) 0x40098000)->CFG;
  tmpreg_CFG &= ~(((uint32_t)0x00000004) | ((uint32_t)0x00000002) | ((uint32_t)0x000000F0));
...
void COMP_CVRefStructInit(COMP_CVRefInitTypeDef* COMP_CVRefInitStruct)
{
  COMP_CVRefInitStruct->COMP_CVRefSource = (((uint32_t)0x0) << 2);
  COMP_CVRefInitStruct->COMP_CVRefRange  = (((uint32_t)0x0) << 1);
  COMP_CVRefInitStruct->COMP_CVRefScale  = (((uint32_t)0x0) << 4);
}
...
void COMP_CVRefSourceConfig(uint32_t Source)
{
  ...
  tmpreg_CFG = ((COMP_TypeDef*) 0x40098000)->CFG;
  tmpreg_CFG &= ~((uint32_t)0x00000004);
  tmpreg_CFG += Source;
  ((COMP_TypeDef*) 0x40098000)->CFG = tmpreg_CFG;
}
...
void COMP_CVRefRangeConfig(uint32_t Range)
{
  ...
  tmpreg_CFG = ((COMP_TypeDef*) 0x40098000)->CFG;
  tmpreg_CFG &= ~((uint32_t)0x00000002);
  tmpreg_CFG += Range;
  ((COMP_TypeDef*) 0x40098000)->CFG = tmpreg_CFG;
}
...
void COMP_CVRefScaleConfig(uint32_t Scale)
{
  ...
  tmpreg_CFG = ((COMP_TypeDef*) 0x40098000)->CFG;
  tmpreg_CFG &= ~((uint32_t)0x000000F0);
  tmpreg_CFG += Scale;
  ((COMP_TypeDef*) 0x40098000)->CFG = tmpreg_CFG;
}
...
uint32_t COMP_GetResultLatch(void)
{
  return ((COMP_TypeDef*) 0x40098000)->RESULT_LATCH;
}
...
uint32_t COMP_GetStatus(void)
{
  return ((COMP_TypeDef*) 0x40098000)->RESULT;
}
...
void COMP_ITConfig(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    tmpreg_CFG |= ((uint32_t)0x00002000);
  }
  else
  {
