#line 1 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_can.c"
...
#line 25 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_can.c"
...
#line 26 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_can.c"
#line 1 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_can.h"
...
#line 30 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_can.h"
#line 31 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_can.h"
...
#line 202 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_can.h"

#line 211 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_can.h"
...
#line 226 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_can.h"

#line 235 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_can.h"
...
#line 250 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_can.h"

#line 259 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_can.h"
...
#line 313 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_can.h"

#line 320 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_can.h"
...
#line 394 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_can.h"
...
#line 452 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_can.h"
...
#line 467 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\inc\\1986BE9x_can.h"
...
void CAN_Init(CAN_TypeDef* CANx, const CAN_InitTypeDef* CAN_InitStruct);
void CAN_StructInit(CAN_InitTypeDef* CAN_InitStruct);
void CAN_FilterInit(CAN_TypeDef* CANx, uint32_t BufferNumber, CAN_FilterInitTypeDef* CAN_FilterInitStruct);
void CAN_ITConfig(CAN_TypeDef* CANx, uint32_t CAN_IT, FunctionalState NewState);
uint32_t CAN_GetDisabledBuffer(CAN_TypeDef* CANx);
uint32_t CAN_GetEmptyTransferBuffer(CAN_TypeDef* CANx);
void CAN_Transmit(CAN_TypeDef* CANx, uint32_t BufferNumber, CAN_TxMsgTypeDef* TxMessage);
void CAN_SendRTR(CAN_TypeDef* CANx, uint32_t BufferNumber, CAN_RTRMessageTypeDef* RTRMessage);
void CAN_RTRReply(CAN_TypeDef* CANx, uint32_t BufferNumber, CAN_RTRReplyTypeDef* RTRReplyMessage);
void CAN_Receive(CAN_TypeDef* CANx, uint32_t BufferNumber, FunctionalState OverWrite);
void CAN_GetReceivedData(CAN_TypeDef* CANx, uint32_t BufferNumber, CAN_DataTypeDef RxBuffer);
void CAN_GetRawReceivedData(CAN_TypeDef* CANx, uint32_t BufferNumber, CAN_RxMsgTypeDef* RxMessage);
void CAN_BufferRelease(CAN_TypeDef* CANx, uint32_t BufferNumber);
void CAN_Cmd(CAN_TypeDef* CANx, FunctionalState NewState);
uint32_t CAN_GetStatus(CAN_TypeDef* CANx);
uint32_t CAN_GetBufferStatus(CAN_TypeDef* CANx, uint32_t BufferNumber);
ITStatus CAN_GetITStatus(CAN_TypeDef* CANx, uint32_t CAN_IT);
void CAN_ITClearErrorPendingBit(CAN_TypeDef* CANx, uint32_t Status_Flag);
void CAN_RxITConfig(CAN_TypeDef* CANx, uint32_t Buffer_IT, FunctionalState NewState);
ITStatus CAN_GetRxITStatus(CAN_TypeDef* CANx, uint32_t BufferNumber);
uint32_t CAN_GetRx(CAN_TypeDef* CANx);
void CAN_TxITConfig(CAN_TypeDef* CANx, uint32_t Buffer_IT, FunctionalState NewState);
ITStatus CAN_GetTxITStatus(CAN_TypeDef* CANx, uint32_t BufferNumber);
void CAN_ITClearRxTxPendingBit(CAN_TypeDef* CANx, uint32_t BufferNumber, uint32_t Status_Flag);

void CAN_BRGInit(CAN_TypeDef* CANx, uint32_t CAN_BRG);
...
#line 27 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_can.c"
...
uint32_t CAN_GetDisabledBuffer(CAN_TypeDef* CANx)
{
  ...
  for (buffer_number = 0; (buffer_number < ((uint32_t)32)) &&
        ((CANx->BUF_CON[buffer_number] & (((uint32_t)0x1) << 0)) == 0);
        buffer_number++)
  {
  }
...
void CAN_BRGInit(CAN_TypeDef* CANx, uint32_t CAN_BRG)
{
  ...
  tmpreg = ((RST_CLK_TypeDef*) 0x40020000)->CAN_CLOCK;

  if (CANx == ((CAN_TypeDef*) 0x40000000))
  {
    tmpreg |= ((uint32_t)0x01000000);
    tmpreg &= ~((uint32_t)0x000000FF);
    tmpreg |= CAN_BRG;
  }
  else if (CANx == ((CAN_TypeDef*) 0x40008000))
  {
  ...
  ((RST_CLK_TypeDef*) 0x40020000)->CAN_CLOCK = tmpreg;
}
