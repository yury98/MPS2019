#line 1 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_bkp.c"
...
#line 24 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_bkp.c"
...
#line 25 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_bkp.c"
...
#line 26 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_bkp.c"
...
#line 64 "..\\..\\..\\Library\\Libraries\\1986BE9x_StdPeriph_Driver\\src\\1986be9x_bkp.c"
...
void BKP_DeInit(void)
{
  ...
  for ( i = 0; i < ((uint32_t) (((uint32_t)&((BKP_TypeDef*)(0x400D8000 - 0x40000000))->REG_0E) - (0x400D8000 - 0x40000000))/4); i++)
  {
    _bkp[i] = 0;
  }

  for ( i = ((uint32_t) (((uint32_t)&((BKP_TypeDef*)(0x400D8000 - 0x40000000))->RTC_CNT) - (0x400D8000 - 0x40000000))/4); i <= ((uint32_t) (((uint32_t)&((BKP_TypeDef*)(0x400D8000 - 0x40000000))->RTC_CS) - (0x400D8000 - 0x40000000))/4); i++)
  {
    _bkp[i] = 0;
  }

  ((BKP_TypeDef*) 0x400D8000) -> REG_0E |= (uint32_t) (((uint32_t)(0x01U<<11)));
  ((BKP_TypeDef*) 0x400D8000) -> REG_0E &= (uint32_t) (((uint32_t)(~((0x01U<<31)|(0x07U<<8)|(0x3FU)))));
  ((BKP_TypeDef*) 0x400D8000) -> REG_0F = (uint32_t) (((uint32_t)0x00008000));
}
...
void BKP_JTAGA_Enable(FunctionalState NewState)
{
  ...
  *(volatile uint32_t *) (0x42000000 + ((uint32_t)&((BKP_TypeDef*)(0x400D8000 - 0x40000000))->REG_0E)*32 + 6*4) = (uint32_t)NewState;
}
...
void BKP_JTAGB_Enable(FunctionalState NewState)
{
  ...
  *(volatile uint32_t *) (0x42000000 + ((uint32_t)&((BKP_TypeDef*)(0x400D8000 - 0x40000000))->REG_0F)*32 + 30*4) = (uint32_t)NewState;
}
...
void BKP_RTCclkSource(uint32_t RTC_CLK)
{
  ...
  tmpreg  = ((BKP_TypeDef*) 0x400D8000) -> REG_0F & (uint32_t) (~((uint32_t)0x0000000C));
   
  tmpreg |= ((uint32_t)0x0000000C) & RTC_CLK;
  ((BKP_TypeDef*) 0x400D8000) -> REG_0F = tmpreg;
}
...
void BKP_RTC_Enable(FunctionalState NewState)
{
  ...
  *(volatile uint32_t *) (0x42000000 + ((uint32_t)&((BKP_TypeDef*)(0x400D8000 - 0x40000000))->REG_0F)*32 + 4*4) = (uint32_t)NewState;
}
...
void BKP_RTC_Calibration(uint32_t RTC_Calibration)
{
  ...
  tmpreg  = ((BKP_TypeDef*) 0x400D8000) -> REG_0F & (uint32_t) (~((uint32_t)0x00001FE0));
...
void BKP_RTC_Reset(FunctionalState NewState)
{
  ...
  *(volatile uint32_t *) (0x42000000 + ((uint32_t)&((BKP_TypeDef*)(0x400D8000 - 0x40000000))->REG_0F)*32 + 31*4) = (uint32_t)NewState;
}
...
void BKP_RTC_ITConfig(uint32_t BKP_RTC_IT, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ((BKP_TypeDef*) 0x400D8000)->RTC_CS |= BKP_RTC_IT;
  }
  else
  {
    ((BKP_TypeDef*) 0x400D8000)->RTC_CS &= (uint32_t)~BKP_RTC_IT;
  }
}
...
uint32_t BKP_RTC_GetCounter(void)
{
  return ((BKP_TypeDef*) 0x400D8000) -> RTC_CNT;
}
...
void BKP_RTC_SetCounter(uint32_t CounterValue)
{
  ((BKP_TypeDef*) 0x400D8000) -> RTC_CNT = CounterValue;
}
...
void BKP_RTC_SetAlarm(uint32_t AlarmValue)
{
  ((BKP_TypeDef*) 0x400D8000) -> RTC_ALRM = AlarmValue;
}
...
uint32_t BKP_RTC_GetDivider(void)
{
  return ((BKP_TypeDef*) 0x400D8000) -> RTC_DIV;
}
...
void BKP_RTC_SetPrescaler(uint32_t PrescalerValue)
{
  ...
  ((BKP_TypeDef*) 0x400D8000) -> RTC_PRL = PrescalerValue;
}
...
void BKP_RTC_WaitForUpdate(void)
{
  ...
  while (*(volatile uint32_t *) (0x42000000 + ((uint32_t)&((BKP_TypeDef*)(0x400D8000 - 0x40000000))->RTC_CS)*32 + 6*4) != 0)
  {
  }
}
...
FlagStatus BKP_RTC_GetFlagStatus(uint32_t BKP_RTC_FLAG)
{
  ...
  if ((((BKP_TypeDef*) 0x400D8000) -> RTC_CS & BKP_RTC_FLAG) != 0)
  {
    status = SET;
  }
  else
