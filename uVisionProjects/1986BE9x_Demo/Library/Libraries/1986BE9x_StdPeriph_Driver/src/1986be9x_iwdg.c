/**
  ...
  */
/* Includes ------------------------------------------------------------------*/
#include "1986BE9x_iwdg.h"
#include "1986BE9x_config.h"

#define ASSERT_INFO_FILE_ID FILEID__1986BE9X_IWDG_C
