...
/* Includes ------------------------------------------------------------------*/
#include "1986BE9x_ssp.h"
#include "1986BE9x_rst_clk.h"
#include "1986BE9x_config.h"

#define ASSERT_INFO_FILE_ID FILEID__1986BE9X_SSP_C
...
void SSP_StructInit(SSP_InitTypeDef* SSP_InitStruct)
{
  ...
  /* Initialize the SSP максимальную скорость обмена дл€ Master mode */
...
/**
  * @brief  Clears the SSPxТs interrupt pending bits.
...
/**
  * @brief  Enables or disables the SSPТs DMA interface.
  * @param  SSPx: Select the SSP peripheral.
  *         This parameter can be one of the following values:
  *         SSP1, SSP2.
