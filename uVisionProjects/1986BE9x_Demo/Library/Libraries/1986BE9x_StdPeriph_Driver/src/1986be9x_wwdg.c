/**
  ...
  */
/* Includes ------------------------------------------------------------------*/
#include "1986BE9x_wwdg.h"
#include "1986BE9x_rst_clk.h"
#include "1986BE9x_config.h"

#define ASSERT_INFO_FILE_ID FILEID__1986BE9X_WWDG_C
...
#define WWDG_BB(SFR, BIT)           BB_ADDR(WWDG_TypeDef, WWDG_OFFSET, SFR, BIT)
...
void WWDG_SetWindowValue(uint32_t WindowValue)
{
  ...
  tmpreg = WWDG->CFR & (uint32_t) (~WIN_Mask);
