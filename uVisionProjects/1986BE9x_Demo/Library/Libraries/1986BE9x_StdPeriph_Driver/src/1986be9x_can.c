...
#include "1986BE9x_can.h"

#define ASSERT_INFO_FILE_ID FILEID__1986BE9X_CAN_C
...
void CAN_BRGInit(CAN_TypeDef* CANx, uint32_t CAN_BRG)
{
  ...
  RST_CLK->CAN_CLOCK = tmpreg;
}

/**
  * @brief  Service function for some SFRs reading
  *         supporting 1986BE9x Series Errata Notice,
  *         Error 0002 workaround.
  * @param  SFR: specifies SFR address
  * @retval SFR value
  * @note   If WORKAROUND_1986BE9X_ERROR_0002 is defined
...
#ifdef WORKAROUND_1986BE9X_ERROR_0002
  /*
   * 1986BE9x Series Errata Notice, Error 0002:
...
#else
  return *SFR;
#endif  /* WORKAROUND_1986BE9X_ERROR_0002 */
}
