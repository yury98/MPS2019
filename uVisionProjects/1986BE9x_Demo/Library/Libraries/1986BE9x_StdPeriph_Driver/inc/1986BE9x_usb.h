...
#ifndef __1986BE9x_USB_H
#define __1986BE9x_USB_H
...
#define USB_SC_SCGEN_Set                     (uint32_t)(1 << USB_SC_SCGEN_Pos)
#define USB_SC_SCGEN_Reset                   (uint32_t)(1 << (USB_SC_SCGEN_Pos + 16))

#define USB_SC_SCTXLS_DM_Set                 (uint32_t)(1 << USB_SC_SCTXLS_Pos)
#define USB_SC_SCTXLS_DM_Reset               (uint32_t)(1 << (USB_SC_SCTXLS_Pos + 16))

#define USB_SC_SCTXLS_DP_Set                 (uint32_t)(1 << (USB_SC_SCTXLS_Pos + 1))
#define USB_SC_SCTXLS_DP_Reset               (uint32_t)(1 << (USB_SC_SCTXLS_Pos + 16 + 1))

#define USB_SC_SCDC_Direct                   (uint32_t)(1 << USB_SC_SCDC_Pos)
#define USB_SC_SCDC_Normal                   (uint32_t)(1 << (USB_SC_SCDC_Pos + 16))

#define USB_SC_SCFSP_Full                    (uint32_t)(1 << USB_SC_SCFSP_Pos)
#define USB_SC_SCFSP_Low                     (uint32_t)(1 << (USB_SC_SCFSP_Pos + 16))

#define USB_SC_SCFSR_12Mb                    (uint32_t)(1 << USB_SC_SCFSR_Pos)
#define USB_SC_SCFSR_1_5Mb                   (uint32_t)(1 << (USB_SC_SCFSR_Pos + 16))
...
#endif /* __1986BE9x_USB_H */

/******************* (C) COPYRIGHT 2011 Phyton *********
*
* END OF FILE 1986BE9x_usb.h */
