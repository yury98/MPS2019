...
#ifndef __1986BE9x_CAN_H
#define __1986BE9x_CAN_H
...
#define CAN_RTR_REMOTE              (((uint32_t)0x1) << CAN_RXDLC_RTR_Pos)  /*!< Remote frame */
...
#define CAN_STDID_TO_EXTID(STDID)  ((STDID) << CAN_BUF_ID_SID_Pos)
#define CAN_EXTID_TO_STDID(EXTID)  ((EXTID) >> CAN_BUF_ID_SID_Pos)
...
#endif /* __1986BE9x_CAN_H */

/******************* (C) COPYRIGHT 2011 Phyton *********
*
* END OF FILE 1986BE9x_can.h */
