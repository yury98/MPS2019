...
#ifndef __1986BE9X_DAC_H
#define __1986BE9X_DAC_H
...
#define DAC_SYNC_MODE_Independent             (((uint32_t)0x0) << DAC_CFG_Cfg_SYNC_A_Pos) /*!< The independent DAC1, DAC2 operation mode. */
#define DAC_SYNC_MODE_Synchronous             (((uint32_t)0x1) << DAC_CFG_Cfg_SYNC_A_Pos) /*!< The synchronous DAC1, DAC2 operation mode. */
...
#define DAC1_AVCC                             (((uint32_t)0x0) << DAC_CFG_Cfg_M_REF0_Pos)   /*!< Selects AVcc as Reference Voltage. */
#define DAC1_REF                              (((uint32_t)0x1) << DAC_CFG_Cfg_M_REF0_Pos)   /*!< Selects DAC1_REF input as Reference Voltage. */
...
#define DAC2_AVCC                             (((uint32_t)0x0) << DAC_CFG_Cfg_M_REF1_Pos)   /*!< Selects AVcc as Reference Voltage. */
#define DAC2_REF                              (((uint32_t)0x1) << DAC_CFG_Cfg_M_REF1_Pos)   /*!< Selects DAC2_REF input as Reference Voltage. */
...
#endif /* __1986BE9X_DAC_H */

/******************* (C) COPYRIGHT 2011 Phyton *********************************
*
* END OF FILE 1986BE9x_dac.h */
