...
#ifndef __1986BE9x_PORT_H
#define __1986BE9x_PORT_H
...
#define PORT_JTAG                   PORTB    /*!< Port containing JTAG interface */
#define PORT_JTAG_Msk               0x001FU  /*!< JTAG pins */

#elif defined (USE_JTAG_B)
#define PORT_JTAG                   PORTD    /*!< Port containing JTAG interface */
#define PORT_JTAG_Msk               0x001FU  /*!< JTAG pins */
...
#endif /* __1986BE9x_PORT_H */

/******************* (C) COPYRIGHT 2010 Phyton *********************************
*
* END OF FILE 1986BE9x_port.h */
