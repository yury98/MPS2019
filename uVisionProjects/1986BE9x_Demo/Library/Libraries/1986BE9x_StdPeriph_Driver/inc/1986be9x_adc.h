...
#ifndef __1986BE9X_ADC_H
#define __1986BE9X_ADC_H
...
#define ADC_SyncMode_Independent              (((uint32_t)0x0) << ADC1_CFG_Cfg_Sync_Conver_Pos) /*!< The independent ADC1, ADC2 operation mode. */
#define ADC_SyncMode_Synchronous              (((uint32_t)0x1) << ADC1_CFG_Cfg_Sync_Conver_Pos) /*!< The synchronous ADC1, ADC2 operation mode. */
...
#define ADC_CLOCK_SOURCE_CPU                  (((uint32_t)0x0) << ADC1_CFG_Cfg_REG_CLKS_Pos)   /*!< Selects CPU_CLK as ADC clock. */
#define ADC_CLOCK_SOURCE_ADC                  (((uint32_t)0x1) << ADC1_CFG_Cfg_REG_CLKS_Pos)   /*!< Selects ADC_CLK as ADC clock. */
...
#define ADC_SAMPLING_MODE_SINGLE_CONV         (((uint32_t)0x0) << ADC1_CFG_Cfg_REG_SAMPLE_Pos)   /*!< Selects ADC single mode operation. */
#define ADC_SAMPLING_MODE_CICLIC_CONV         (((uint32_t)0x1) << ADC1_CFG_Cfg_REG_SAMPLE_Pos)   /*!< Selects ADC ciclic mode operation. */
...
#define ADC_CH_SWITCHING_Disable              (((uint32_t)0x0) << ADC1_CFG_Cfg_REG_CHCH_Pos)   /*!< Disables Channel Swithing. */
#define ADC_CH_SWITCHING_Enable               (((uint32_t)0x1) << ADC1_CFG_Cfg_REG_CHCH_Pos)   /*!< Enables Channel Swithing. */
...
#define ADC_LEVEL_CONTROL_Disable             (((uint32_t)0x0) << ADC1_CFG_Cfg_REG_RNGC_Pos)   /*!< Disables Level Control. */
#define ADC_LEVEL_CONTROL_Enable              (((uint32_t)0x1) << ADC1_CFG_Cfg_REG_RNGC_Pos)   /*!< Enables Level Control. */
...
#define ADC_VREF_SOURCE_INTERNAL              (((uint32_t)0x0) << ADC1_CFG_Cfg_M_REF_Pos)   /*!< Selects Internal Voltage Reference. */
#define ADC_VREF_SOURCE_EXTERNAL              (((uint32_t)0x1) << ADC1_CFG_Cfg_M_REF_Pos)   /*!< Selects External Voltage Reference. */
...
#define ADC_CLK_div_None                      (((uint32_t)0x0) << ADC1_CFG_Cfg_REG_DIVCLK_Pos) /*!< The input ADC clock devides by 1.     */
#define ADC_CLK_div_2                         (((uint32_t)0x1) << ADC1_CFG_Cfg_REG_DIVCLK_Pos) /*!< The input ADC clock devides by 2.     */
#define ADC_CLK_div_4                         (((uint32_t)0x2) << ADC1_CFG_Cfg_REG_DIVCLK_Pos) /*!< The input ADC clock devides by 4.     */
#define ADC_CLK_div_8                         (((uint32_t)0x3) << ADC1_CFG_Cfg_REG_DIVCLK_Pos) /*!< The input ADC clock devides by 8.     */
#define ADC_CLK_div_16                        (((uint32_t)0x4) << ADC1_CFG_Cfg_REG_DIVCLK_Pos) /*!< The input ADC clock devides by 16.    */
#define ADC_CLK_div_32                        (((uint32_t)0x5) << ADC1_CFG_Cfg_REG_DIVCLK_Pos) /*!< The input ADC clock devides by 32.    */
#define ADC_CLK_div_64                        (((uint32_t)0x6) << ADC1_CFG_Cfg_REG_DIVCLK_Pos) /*!< The input ADC clock devides by 64.    */
#define ADC_CLK_div_128                       (((uint32_t)0x7) << ADC1_CFG_Cfg_REG_DIVCLK_Pos) /*!< The input ADC clock devides by 128.   */
#define ADC_CLK_div_256                       (((uint32_t)0x8) << ADC1_CFG_Cfg_REG_DIVCLK_Pos) /*!< The input ADC clock devides by 256.   */
#define ADC_CLK_div_512                       (((uint32_t)0x9) << ADC1_CFG_Cfg_REG_DIVCLK_Pos) /*!< The input ADC clock devides by 512.   */
#define ADC_CLK_div_1024                      (((uint32_t)0xA) << ADC1_CFG_Cfg_REG_DIVCLK_Pos) /*!< The input ADC clock devides by 1024.  */
#define ADC_CLK_div_2048                      (((uint32_t)0xB) << ADC1_CFG_Cfg_REG_DIVCLK_Pos) /*!< The input ADC clock devides by 2048.  */
#define ADC_CLK_div_4096                      (((uint32_t)0xC) << ADC1_CFG_Cfg_REG_DIVCLK_Pos) /*!< The input ADC clock devides by 4096.  */
#define ADC_CLK_div_8192                      (((uint32_t)0xD) << ADC1_CFG_Cfg_REG_DIVCLK_Pos) /*!< The input ADC clock devides by 8192.  */
#define ADC_CLK_div_16384                     (((uint32_t)0xE) << ADC1_CFG_Cfg_REG_DIVCLK_Pos) /*!< The input ADC clock devides by 16384. */
#define ADC_CLK_div_32768                     (((uint32_t)0xF) << ADC1_CFG_Cfg_REG_DIVCLK_Pos) /*!< The input ADC clock devides by 32768. */
...
#endif /* __1986BE9X_ADC_H */

/******************* (C) COPYRIGHT 2011 Phyton *********************************
*
* END OF FILE 1986BE9x_adc.h */
